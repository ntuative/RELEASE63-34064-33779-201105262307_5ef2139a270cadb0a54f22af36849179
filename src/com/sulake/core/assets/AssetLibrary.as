package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_794:String = "AssetLibraryLoaded";
      
      public static const const_1901:String = "AssetLibraryUnloaded";
      
      public static const const_1908:String = "AssetLibraryLoadError";
      
      private static const const_462:String = "name";
      
      private static const const_1006:String = "asset";
      ...
      private static var var_299:Dictionary;
      
      private static var var_1736:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_507;
         this.var_426 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1005);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1006);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_462);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_930.splice(var_930.indexOf(this),1);
            --var_507;
            this.var_508 = null;
            this.var_932 = null;
            this.var_160 = null;
      ...
      {
         if(this.var_605 == param1.url && this.var_933)
         {
            if(!this.var_931 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_604);
            }
            this.var_931 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_933 = false;
         this.var_605 = null;
         dispatchEvent(new Event(AssetLibrary.const_1901));
      }
      ...
      {
         return this.var_160[param1] != null || (this.var_604 != null ? this.var_604[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1736.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_299.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_299[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_426.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_426[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_299[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_426[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_299)
            {
               _loc3_ = AssetTypeDeclaration(var_299[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_426)
         {
            _loc3_ = AssetTypeDeclaration(this.var_426[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_299)
            {
               _loc4_ = AssetTypeDeclaration(var_299[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_426)
         {
            _loc4_ = AssetTypeDeclaration(this.var_426[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_933 = true;
         dispatchEvent(new Event(AssetLibrary.const_794));
         dispatchEvent(new Event(AssetLibrary.const_1310));
         if(this.var_931)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1908));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1005);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1006);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_462).toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_604[param1]);
