package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1101 = new LoaderContext();
         this.var_1101.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1101);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_338 = 0;
         this.var_43.load(param1,this.var_1101);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_338 < var_2961)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1100 + (this.var_1100.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_338),this.var_1101);
               return true;
            }
         }
         return false;
