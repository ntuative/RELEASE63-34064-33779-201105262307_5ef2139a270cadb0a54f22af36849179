package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1422:String = "_SELECTOR";
      
      private static const const_1423:String = "_CONTENT";
       
      
      protected var var_1098:ITabSelectorWindow;
      
      protected var var_2168:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1098 = findChildByTag(const_1422) as ITabSelectorWindow;
            if(this.var_1098 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2168 = findChildByTag(const_1423) as IWindowContainer;
         }
      ...
      {
         return !!this.var_807 ? this.selector.iterator : null;
      }
