package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_777 ? true : null;
         }
      ...
      {
         this.var_892 = param1;
         this._field.scrollH = this.var_892 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_892 * this.maxScrollH,this.var_578 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_693,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1312));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1159 ? new PropertyStruct(PropertyDefaults.const_824,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1350) : PropertyDefaults.const_1785);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1194 ? new PropertyStruct(PropertyDefaults.const_1333,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1329) : PropertyDefaults.const_1794);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_750) ? new PropertyStruct(PropertyDefaults.const_406,this._field.textColor,PropertyStruct.const_157,true) : PropertyDefaults.const_1123);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_907 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.left,PropertyStruct.const_41,true) : PropertyDefaults.const_850);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_898 ? new PropertyStruct(PropertyDefaults.const_243,this.var_42.top,PropertyStruct.const_41,true) : PropertyDefaults.const_825);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_804 ? new PropertyStruct(PropertyDefaults.const_267,this.var_42.right,PropertyStruct.const_41,true) : PropertyDefaults.const_964);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_895 ? new PropertyStruct(PropertyDefaults.const_255,this.var_42.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_868);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1163 ? new PropertyStruct(PropertyDefaults.const_865,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1873);
