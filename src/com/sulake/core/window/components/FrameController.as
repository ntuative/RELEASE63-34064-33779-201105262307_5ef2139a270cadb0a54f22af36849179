package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1504:String = "_TITLE";
      
      private static const const_1502:String = "_HEADER";
      
      private static const const_1501:String = "_CONTENT";
      
      private static const const_1503:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1501:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1504) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1501 = findChildByTag(const_1502) as IHeaderWindow;
            if(!this.var_1501)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_189 = findChildByTag(const_1501) as IWindowContainer;
            if(!this.var_189)
            {
      ...
      {
         return findChildByTag(const_1503) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1103 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_284);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,_loc3_.left,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,_loc3_.top,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         return _loc1_;
      }
