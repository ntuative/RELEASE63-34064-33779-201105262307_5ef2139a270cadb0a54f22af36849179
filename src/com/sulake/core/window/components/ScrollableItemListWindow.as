package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1242:IItemListWindow;
      
      private var var_455:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_455)
         {
            this.var_455.removeEventListener(WindowEvent.const_281,this.scrollBarEventProc);
            this.var_455.removeEventListener(WindowEvent.const_263,this.scrollBarEventProc);
            this.var_455 = null;
         }
         if(this.var_1242)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1242)
         {
            this.var_1242 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_455)
         {
            this.var_455 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_455)
            {
               this.var_455.addEventListener(WindowEvent.const_281,this.scrollBarEventProc);
               this.var_455.addEventListener(WindowEvent.const_263,this.scrollBarEventProc);
            }
         }
         return this.var_455;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_263)
         {
            this.hideScrollBar();
         }
      }
