package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1642:uint = 500;
      
      protected var var_1368:String = "";
      
      protected var var_1376:Boolean = false;
      ...
      {
         this.var_1368 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1147,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_807 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_335,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_972,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1871);
         _loc1_.push(this.var_1376 != PropertyDefaults.const_1258 ? new PropertyStruct(PropertyDefaults.const_707,this.var_1376,PropertyStruct.const_38,true) : PropertyDefaults.const_1814);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1213 ? new PropertyStruct(PropertyDefaults.const_928,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1663);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1212 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1941);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_707:
                  this.var_1376 = _loc2_.value as Boolean;
                  if(this.var_1376)
                  {
