package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_565)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_791,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1679);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1210)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_696,param1.toolTipDelay,PropertyStruct.const_275,true));
         }
         else
         {
      ...
      {
         this.var_1368 = param1 == null ? "null" : param1;
      }
