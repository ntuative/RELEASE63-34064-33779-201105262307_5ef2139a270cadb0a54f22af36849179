package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_351)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1241)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_886;
         if(this.var_886 != param1)
         {
            if(this.var_886 != null)
            {
               if(!this.var_886.disposed)
               {
                  this.var_886.deactivate();
               }
            }
            this.var_886 = param1;
