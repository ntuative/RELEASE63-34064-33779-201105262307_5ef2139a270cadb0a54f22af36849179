package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1860:uint = 0;
      
      public static const const_909:uint = 1;
      
      public static const const_1147:uint = 2;
      
      public static const const_931:uint = 4;
      
      public static const const_1893:uint = 8;
      
      public static const const_1751:uint = 16;
      
      public static const const_2210:uint = 64;
      
      public static const const_2190:uint = 128;
      
      public static const const_1265:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_909:
               ...
               break;
            case GraphicContext.const_1147:
         ...
         if(this.var_894)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2190,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2190,16777215);
                  }
                  var_342 += bitmap.width * bitmap.height * 4;
               }
