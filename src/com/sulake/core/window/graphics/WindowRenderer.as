package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1812:Point;
      
      private var var_1466:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1812 = new Point();
         this.var_1466 = new Rectangle();
         this.var_305 = new Rectangle();
         this.var_362 = new Dictionary(true);
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_305,WindowRedrawFlag.const_1202);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_362[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_362[param1];
         }
         return _loc2_;
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1812,this.var_1466))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1812,this.var_1466))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_34))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1466);
