         ...
         if(_loc8_.length() > 0)
         {
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_334 = SkinLayoutEntity.const_305;
                  break;
               case "strech":
                  _loc5_.var_334 = SkinLayoutEntity.const_622;
                  break;
               case "tiled":
                  _loc5_.var_334 = SkinLayoutEntity.const_337;
                  break;
               case "center":
                  _loc5_.var_334 = SkinLayoutEntity.const_512;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_333 = SkinLayoutEntity.const_515;
                  break;
               case "move":
                  _loc5_.var_333 = SkinLayoutEntity.const_305;
                  break;
               case "strech":
                  _loc5_.var_333 = SkinLayoutEntity.const_622;
                  break;
               case "tiled":
                  _loc5_.var_333 = SkinLayoutEntity.const_337;
                  break;
               case "center":
                  _loc5_.var_333 = SkinLayoutEntity.const_512;
            }
         }
