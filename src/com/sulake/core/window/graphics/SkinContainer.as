package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1494:String = "skin";
      
      private static const const_1496:String = "bitmap";
      
      private static const const_1492:String = "fill";
      
      private static const const_1493:String = "text";
      
      private static const const_1495:String = "label";
      
      private static const const_1497:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1849,this.var_2557);
         this.var_2556 = new Dictionary();
         this.var_2555 = new Dictionary();
         StateCodeTable.fillTables(this.var_2556,this.var_2555);
         this.var_448 = new Dictionary();
         this.var_448[const_1494] = BitmapSkinRenderer;
         this.var_448[const_1496] = BitmapDataRenderer;
         this.var_448[const_1492] = FillSkinRenderer;
         this.var_448[const_1493] = TextSkinRenderer;
         this.var_448[const_1495] = LabelRenderer;
         this.var_448[const_1497] = ShapeSkinRenderer;
         this.var_448[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_448[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_341 == null)
         {
            var_341 = new Array();
            var_341.push(WindowState.const_70);
            var_341.push(WindowState.const_88);
            var_341.push(WindowState.const_91);
            var_341.push(WindowState.const_56);
            var_341.push(WindowState.const_85);
            var_341.push(WindowState.const_87);
            var_341.push(WindowState.const_86);
            var_341.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2941 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1849[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_994[param1] = new Array(const_1042);
         }
         this.var_994[param1][param2] = param3;
         if(this.var_993[param1] == null)
         {
            this.var_993[param1] = new Array(const_1042);
         }
         this.var_993[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_994[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_993[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_181)
