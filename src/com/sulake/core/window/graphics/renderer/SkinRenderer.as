   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_577[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_577[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_577[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_577[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_577[param1.name];
         }
         return param1;
      }
