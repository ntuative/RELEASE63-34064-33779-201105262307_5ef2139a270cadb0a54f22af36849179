package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_340 = new Array();
            var_340[0] = MouseCursorType.const_359;
            var_340[1] = MouseCursorType.const_30;
            var_340[2] = MouseCursorType.const_359;
            var_340[3] = MouseCursorType.const_359;
            var_340[4] = MouseCursorType.const_359;
            var_340[5] = MouseCursorType.const_30;
            var_340[6] = MouseCursorType.const_359;
         }
         if(var_291 == null)
         {
            var_291 = new Array();
            var_291[0] = WindowState.const_86;
            var_291[1] = WindowState.const_87;
            var_291[2] = WindowState.const_85;
            var_291[3] = WindowState.const_70;
            var_291[4] = WindowState.const_56;
            var_291[5] = WindowState.const_91;
            var_291[6] = WindowState.const_88;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_66 = state.var_1354 as WindowController;
         this.var_176 = state.var_1352 as WindowController;
         this.var_172 = state.renderer;
         this.var_887 = state.var_1353;
         eventQueue.begin();
         this.var_705.x = -1;
         this.var_705.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_705.x || event.stageY != this.var_705.y)
            {
               this.var_705.x = event.stageX;
               this.var_705.y = event.stageY;
               array = new Array();
               this.var_87.groupParameterFilteredChildrenUnderPoint(this.var_705,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_66.getGlobalPosition(var_412);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_66 && !this.var_66.disposed)
                     {
                        ...
                        {
                           this.var_887.mouseEventReceived(event.type,this.var_66);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1354 = this.var_66;
         state.var_1352 = this.var_176;
         state.renderer = this.var_172;
         state.var_1353 = this.var_887;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_572))
         {
