package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_646:String = "}";
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_646);
         if(countSubStrings(param1,const_647) != countSubStrings(param1,const_646))
         {
            throw new Error("Mismatching amount of \"" + const_647 + "\" versus \"" + const_646 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_647)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
