package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_1023:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_1023[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_777 ? true : null;
