package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1527:String = "asset-libraries";
      
      private static const const_1528:String = "library";
      
      private static const const_1531:String = "service-libraries";
      
      private static const const_1526:String = "library";
      
      private static const const_1529:String = "component-libraries";
      
      private static const const_1524:String = "library";
      
      private static const const_1530:String = "error_data";
      
      private static const const_1523:String = "error_cat";
      
      private static const const_1525:String = "error_desc";
       
      
      private var var_374:LibraryLoaderQueue;
      
      private var var_797:IEventDispatcher;
      
      private var var_535:uint;
      
      private var var_375:Function;
      
      private var var_210:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_889:
               ...
               this.var_210 = new Profiler(this);
               attachComponent(this.var_210,[new IIDProfiler()]);
               var_407.addChild(new ProfilerViewer(this.var_210));
               break;
            case Core.const_588:
      ...
      {
         return this.var_535 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_264[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1523,String(param3));
         ErrorReportStorage.setParameter(const_1525,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_797 = loadingEventDelegate;
         if(this.var_374 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_199,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_199,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_199,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1180);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_797)
         {
            this.var_797.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_797)
         {
            ...
            this.var_797.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_797)
                  {
                     this.var_797.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_535 - this.var_374.length,this.var_535,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_210 ? 0 : this.var_1518 & 0;
         if(_loc3_ == Core.const_588)
         {
            this.var_264[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_264[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_210 ? 0 : this.var_1518 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_104)
         {
            _loc3_ = this.var_264[_loc5_] as Array;
            if(_loc4_ == Core.const_588)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_648[priority] = 0;
            receivers = this.var_264[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            {
               if(this.var_648[priority] < priority)
               {
                  ++this.var_648[priority];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_210.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_210)
            {
               detachComponent(this.var_210);
               this.var_210.dispose();
               this.var_210 = null;
            }
            switch(this.var_1518 & 0)
            {
               case Core.const_1122:
                  this.var_375 = this.simpleFrameUpdateHandler;
                  break;
