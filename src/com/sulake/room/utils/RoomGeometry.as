package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1217:Number = 32;
      ...
      private var var_1677:Number = 1.0;
      
      private var var_1675:Number = 1.0;
      
      private var var_1676:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1118 = new Vector3d();
         this.var_1677 = 1;
         this.var_1675 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1676 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_416.assign(this.var_95);
         this.var_416.x *= this.var_417;
         this.var_416.y *= this.var_420;
         this.var_416.z *= this.var_419;
         return this.var_416;
      }
      ...
      {
         if(this.var_417 != param1 * this.var_1677)
         {
            this.var_417 = param1 * this.var_1677;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_420 != param1 * this.var_1675)
         {
            this.var_420 = param1 * this.var_1675;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_419 != param1 * this.var_1676)
         {
            this.var_419 = param1 * this.var_1676;
            ++this.var_156;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_95.x /= this.var_417;
         this.var_95.y /= this.var_420;
         this.var_95.z /= this.var_419;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_418.x;
         var _loc3_:Number = this.var_418.y;
         var _loc4_:Number = this.var_418.z;
         this.var_418.assign(param1);
         this._direction.assign(param1);
         if(this.var_418.x != _loc2_ || this.var_418.y != _loc3_ || this.var_418.z != _loc4_)
         {
            ++this.var_156;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1119.assign(this.var_164);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1118.assign(_loc22_);
         }
         else
         {
            this.var_1118.assign(_loc17_);
         }
         ++this.var_156;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_417;
         _loc2_.y *= this.var_420;
         _loc2_.z *= this.var_419;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1118);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_420;
            _loc2_.z *= this.var_419;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1118);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_95.x * this.var_417,this.var_95.y * this.var_420,this.var_95.z * this.var_419);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_164;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_417,param2.y * this.var_420,param2.z * this.var_419);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_417,param3.y * this.var_420,param3.z * this.var_419);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_417,param4.y * this.var_420,param4.z * this.var_419);
