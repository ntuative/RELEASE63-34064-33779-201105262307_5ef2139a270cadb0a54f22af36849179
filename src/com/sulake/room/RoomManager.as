package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_674:IRoomObjectFactory = null;
      
      private var var_554:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1297:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_849,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_130.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_130.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_674 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_674 == null || this.var_554 == null)
         {
            return;
         }
         this._state = const_1793;
         if(this.var_1297 != null)
         {
            _loc1_ = this.var_1297;
            this.var_1297 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_673.indexOf(_loc5_) < 0)
            {
      ...
      public function addObjectUpdateCategory(param1:int) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_130.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function method_3(param1:String, param2:XML) : IRoomInstance
      {
         var _loc5_:int = 0;
         if(this._state < const_967)
         {
         ...
         this.var_130.add(String(param1),_loc3_);
      ...
      {
         return this.var_130.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_130.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_554.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_554.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_674.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_674 != null)
         {
            return this.var_674.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_554 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_554.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_130.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_130.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_130.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_554.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_674.createRoomObjectLogic(_loc6_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_130.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_130.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
