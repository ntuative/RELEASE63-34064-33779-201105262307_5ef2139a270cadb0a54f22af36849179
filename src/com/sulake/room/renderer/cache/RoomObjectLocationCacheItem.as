package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1779 || param1.getUpdateID() != this.var_2461)
         {
            this.var_2461 = param1.getUpdateID();
            if(param2.updateId != this.var_1779 || _loc4_.x != this.var_1172.x || _loc4_.y != this.var_1172.y || _loc4_.z != this.var_1172.z)
            {
               this.var_1779 = param2.updateId;
               this.var_1172.assign(_loc4_);
               _loc3_ = true;
            }
         }
