package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2629 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1899 = (param2 & 0) > 0;
         if(!this.var_1899)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1899)
            {
               if("ToggleToRandomState" == this.var_195.getKey("use.default.localizations","ToggleToRandomState"))
               {
                  _loc5_ = this.var_195.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_174,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_174,this.onLocalizationLoaded);
         if(this.var_195.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_195.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_174,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_174,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1900[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1900[param1];
      }
      ...
      {
         return this.var_2629[Math.max(0,param1 - 1)];
      }
   }
}
