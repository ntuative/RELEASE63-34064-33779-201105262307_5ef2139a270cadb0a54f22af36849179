package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_458:uint = 3;
      
      private static const const_1537:uint = 1;
      ...
      private var var_1009:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_266:Array;
      
      private var var_1527:IEventDispatcher;
      
      private var var_1236:Boolean = false;
      
      private var var_1914:ProfilerOutput;
      
      private var var_1529:ProfilerAgentTask;
      
      private var var_1528:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1009 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_458);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_458)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1009,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_247 = this._windowContextArray[const_1537];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1914)
            {
               this.var_1914 = new ProfilerOutput(context,this,this.var_1009);
            }
            this.var_1914.profiler = _loc3_;
            this.var_1529 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1529);
            this.var_1528 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1528);
            this.var_1236 = true;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1527.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_458 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1527.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_458)
         {
         ...
         this.var_1527.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1817,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1723,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1780,param2.name + ": " + param2.toString());
            }
         }
      }
