package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_718)
         {
            this.var_718 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_718)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_717)
         {
            this.var_717 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_717)
            {
               return;
            }
