package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1383:uint = 13232628;
      
      private static var var_1654:uint = 11129827;
      ...
      private var var_1109:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1653 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_718)
         {
            this.var_718 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_718)
            {
               return;
            }
            this._window.content.addChild(this.var_718);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_717)
         {
            this.var_717 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_717)
            {
               return;
            }
            this._window.content.addChild(this.var_717);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_717.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_491;
         }
         this.showView(this.var_717);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1093 || param1 == ChangeUserNameResultMessageEvent.var_1095)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1109 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1109.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1383;
