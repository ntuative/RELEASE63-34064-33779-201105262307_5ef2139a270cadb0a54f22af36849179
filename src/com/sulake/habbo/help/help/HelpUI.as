package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105262302));
         this.var_121 = new Map();
         this.var_121.add(HabboHelpViewEnum.const_1680,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_215,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_532,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_339,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_236,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_421,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_747,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_257,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_121.add(HabboHelpViewEnum.const_1267,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_121.add(HabboHelpViewEnum.const_1113,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_691,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_534.length == 0 || param1 != this.var_372)
            {
               this.var_534.push(this.var_372);
            }
         }
         this.var_372 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_257:
               ...
               break;
            case CallForHelpResultEnum.const_1278:
               this.showUI(HabboHelpViewEnum.const_1113);
               break;
            case CallForHelpResultEnum.const_1191:
               this.showUI(HabboHelpViewEnum.const_1267);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_121.getValue(HabboHelpViewEnum.const_215) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_566));
      }
      ...
      {
         return this.var_121.getValue(this.var_372);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2624 = this._window.width - _loc3_.width;
         this.var_2622 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2622;
         this._window.width = _loc1_.width + this.var_2624;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_534.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_215)
         {
            return;
         }
         if(this.var_647.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_647.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_647[1],this.var_647[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_647[0],this.var_647[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_215 || this.var_534.length == 0)
         {
            return;
         }
         if(this.var_373 == null)
