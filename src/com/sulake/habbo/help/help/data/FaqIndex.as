package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_876:FaqCategory;
      
      private var var_877:FaqCategory;
      
      private var var_878:FaqCategory;
      ...
      {
         super();
         this.var_876 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_877 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_878 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_876.hasItem(param1))
         {
            this.var_876.getItem(param1).answerText = param2;
         }
         if(this.var_877.hasItem(param1))
         {
            this.var_877.getItem(param1).answerText = param2;
         }
         if(this.var_878.hasItem(param1))
         {
            this.var_878.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_876.hasItem(param1))
         {
            return this.var_876.getItem(param1);
         }
         if(this.var_877.hasItem(param1))
         {
            return this.var_877.getItem(param1);
         }
         if(this.var_878.hasItem(param1))
         {
            return this.var_878.getItem(param1);
         }
         var _loc2_:int = 0;
