package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1185:BitmapData = null;
      
      private var var_1184:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2470 = this._config.getKey("interstitial.enabled","ToggleToRandomState") == "true";
         this.var_2469 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2471 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1792 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1792 > 0 && this.var_1791 >= this.var_1792)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1183;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1461 = _loc2_.imageUrl;
         this.var_2468 = _loc2_.clickUrl;
         this.var_1183 = getTimer();
         if(this.var_1461 != "")
         {
            ...
            {
               this.var_231 = new Timer(this.var_2471,1);
            ...
            this.var_231.start();
            _loc4_ = new URLRequest(this.var_1461);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_464,0,0,param1.bitmapData,this.var_2468));
            this.var_1183 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_516));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1462 = _loc2_.imageUrl;
         this.var_1790 = _loc2_.clickUrl;
         if(this.var_1462 != "" && this.var_1790 != "")
         {
            _loc3_ = this.var_1462;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1462);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_561,0,0,_loc4_,_loc2_.assetName,this.var_1790,this.var_1185,this.var_1184));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1185 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1184 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_882,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_949,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
