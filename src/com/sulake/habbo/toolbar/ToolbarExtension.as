package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1538:uint = 12247545;
      
      private static const const_1540:String = "HELP";
      
      private static const const_1541:String = "ROOMINFO";
      ...
      private const const_825:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_59 = this._window.findChildByName("list") as IItemListWindow;
         var _loc7_:* = [];
         this.var_59.groupListItemsWithTag("REGION",_loc7_);
      ...
      {
         this.var_59.removeListItem(this.var_395);
      }
      
      public function showRoomInfo() : void
      {
         this.var_59.addListItemAt(this.var_395,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_964;
         _loc3_.y = this.const_825;
         return _loc3_;
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1541);
               break;
            case "confirm":
               if(false)
               {
