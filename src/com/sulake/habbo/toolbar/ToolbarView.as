package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1556:Point = new Point(3,3);
      
      private static const const_1600:uint = 7433577;
      
      private static const const_1599:uint = 5723213;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1556;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_460 ? this.var_1584 : this.var_1583;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_460)
         {
            param1.color = const_1600;
         }
         else
         {
            param1.color = const_1599;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1583 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1584)
         {
            this.var_1584.dispose();
         }
         this.var_1584 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1066.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_994;
            this.var_1066.add(param1,_loc2_);
         }
         return _loc2_;
      }
