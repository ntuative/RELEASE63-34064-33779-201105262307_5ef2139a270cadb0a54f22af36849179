package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_2065:IAlertDialog;
      ...
      {
         return this._questEngine.configuration.getKey("standaloneAchievementList.enabled","ToggleToRandomState") == "true";
      }
   }
}
