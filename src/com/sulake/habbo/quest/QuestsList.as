package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1383:int = 10;
      
      private static const const_1386:int = 10;
      
      private static const const_1384:int = 30;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_59 = IItemListWindow(this._window.findChildByName("quest_list"));
         this.var_578 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_59.spacing = const_1383;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1386;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1385;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1384;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1694 && !this.var_1693)
            {
               this.var_1694 = false;
