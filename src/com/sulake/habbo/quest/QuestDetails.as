package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1452:int = 56;
      
      private static const const_667:int = 5;
      
      private static const const_1580:int = 5;
      
      private static const const_1582:int = 30;
      
      private static const const_1079:Point = new Point(8,8);
      
      private static const const_1581:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_304 == null || this.var_304.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc9_.x = const_1079.x;
            _loc9_.y = const_1079.y;
         ...
         _loc2_.height = _loc2_.textHeight + const_1580;
         var _loc4_:int = _loc2_.height - _loc3_ + (!!_loc2_.visible ? 0 : const_1582);
         _loc2_.visible = true;
         var _loc5_:IRegionWindow = IRegionWindow(this._window.findChildByName("catalog_link_region"));
         var _loc6_:* = const_1581.indexOf(param1.type) > -1;
         ...
         this._window.height = _loc9_.height + const_1452;
