package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_959:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_959 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1431);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_388.events.removeEventListener(BadgeImageReadyEvent.const_106,this.var_959.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_388.events.addEventListener(BadgeImageReadyEvent.const_106,this.var_959.onBadgeImageReady);
      }
      ...
      {
         return this.var_195.getKey("questing.enabled","ToggleToRandomState") == "true";
      }
