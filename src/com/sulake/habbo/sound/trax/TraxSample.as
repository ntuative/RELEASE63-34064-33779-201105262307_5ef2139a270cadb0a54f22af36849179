package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1819:String = "sample_44khz";
      
      public static const const_1911:String = "sample_22khz";
      
      public static const const_1705:String = "sample_11khz";
      
      public static const const_1688:String = "sample_16bit";
      
      public static const const_1875:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1017:int = 32;
      ...
      private var var_119:Vector.<int> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         this.var_119 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1017)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1017);
            }
            ...
            {
               this.var_119[int(_loc11_ / this.var_161)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_119.length * this.var_161 * this.var_76;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_119 == null)
         {
            return param4;
         }
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_119.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_119.length - param4)) * _loc5_;
            _loc6_ = this.var_119.length - param4;
