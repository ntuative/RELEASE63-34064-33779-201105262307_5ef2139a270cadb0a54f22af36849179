package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_226 = param2;
         this.var_846 = [];
         this.var_846.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_846.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_846)
         {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachinePlayEvent);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_953,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachinePlayEvent);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_953,this.onSoundMachineStopEvent);
               this.var_84 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_475 = -1;
         this.var_686 = false;
         this.var_226.stop(HabboMusicPrioritiesEnum.const_128);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_226.playSong(param1,HabboMusicPrioritiesEnum.const_128,_loc3_,0,0,0))
         {
