package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1536:int = HabboMusicPrioritiesEnum.const_128;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_846.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_846.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_846)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_815,this.onJukeboxInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_234,this.onJukeboxDispose);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_855,this.onSoundMachineInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_878,this.onSoundMachineDispose);
         this.var_1234 = new Timer(1000);
         this.var_1234.start();
         this.var_1234.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_273)
         {
            this.var_314[_loc6_] = null;
            this.var_804[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1907)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_815,this.onJukeboxInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_234,this.onJukeboxDispose);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_855,this.onSoundMachineInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_878,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_273)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_314[param1] = _loc7_;
         this.var_804[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_314[param1];
      ...
      {
         var _loc1_:int = this.var_314.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_314[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_273)
         {
      ...
      {
         if(this.var_651.getValue(param1) == null)
         {
            this.var_651.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_377.length)
         {
            return this.var_377.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_377.length)
         {
            return this.var_377.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_265.length)
         {
            ...
            if(_loc3_.id != this.var_1524 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_314[_loc2_] != null)
            {
               _loc3_ = this.var_314[_loc2_];
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_802.indexOf(_loc6_.id) != -1)
               {
                  this.var_802.splice(this.var_802.indexOf(_loc6_.id),1);
                  if(this.var_802.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_273)
         {
            return false;
         }
         ...
         this.var_1907 = this.getSongRequestCountAtPriority(param1);
         this.var_1524 = param2;
         if(this._priorityPlaying <= const_1536)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_128)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2635 != param1.id || _loc3_ > this.var_2636 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2635 = param1.id;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_377.add(_loc5_,_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_541 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_84,this._connection) as IPlayListController;
      }
