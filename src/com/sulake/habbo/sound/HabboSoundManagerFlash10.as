package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1374:int = 25165823;
      
      private static const const_1375:int = 16777215;
      ...
      private var var_906:IHabboNotifications;
      
      private var var_907:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_816,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_906)
         {
            this.var_906.release(new IIDHabboNotifications());
            this.var_906 = null;
         }
         super.dispose();
      }
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1226:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1674:
               ...
               case HabboSoundTypesEnum.const_1251:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1851:
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1127.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_249,events);
         _loc5_.volume = this.var_907;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_249.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_906.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_906 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_195 == null || this._connection == null || this._roomEngine == null || this.var_226 != null)
         {
            return;
         }
      ...
      protected function method_8(param1:IHabboMusicController) : void
      {
         this.var_226 = param1;
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_226.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1910,this.var_730));
         this.var_730 = -1;
         this.var_731 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_907 * 100)));
         }
      }
      ...
      {
         this.var_907 = param1;
         this.var_226.updateVolume(this.var_907);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_590.getValue(param1) != null)
         {
            _loc2_ = this.var_590.remove(param1);
            if(this.var_249.getValue(_loc2_) == null)
            {
               this.var_1398.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1398,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1398,_loc2_,TraxSample.const_1819,TraxSample.const_1688);
               this.var_249.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1126.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1376 && this.var_1126.length > 0)
            {
               _loc3_ = this.var_1126.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_590.length == 0 && this.var_730 != -1)
            {
               this.var_731.ready = true;
               _loc4_ = this.var_730;
               this.var_730 = -1;
               this.var_731 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_816,_loc4_));
               if(this.var_2285)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_731 == null && this.var_1127.length > 0)
         {
            _loc1_ = this.var_1127.getKey(0);
            _loc2_ = this.var_1127.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_816,_loc1_));
               }
               else
               {
                  this.var_731 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_226.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_249.length)
         {
            _loc5_ = this.var_249.getKey(_loc4_);
            _loc6_ = this.var_249.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1374)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1375 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_249.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_249.remove(_loc11_);
               }
               this.var_226.samplesUnloaded(_loc7_);
            }
         }
      }
