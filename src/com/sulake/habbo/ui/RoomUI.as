package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1314:IRoomWidgetFactory;
      
      private var var_388:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_493:IAvatarRenderManager;
      ...
      private var var_2064:IHabboAvatarEditor = null;
      ...
      private var var_1176:IHabboHelp;
      ...
      private var var_1325:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1602 = RoomDesktop.const_555;
         super(param1,param2,param3);
         var _loc4_:RoomWidgetFactory = new RoomWidgetFactory(this,0,param3);
         this.var_1314 = _loc4_;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_493.release(new IIDAvatarRenderManager());
            this.var_493 = null;
         }
         ...
         {
            this.var_1176.release(new IIDHabboHelp());
            this.var_1176 = null;
         }
         ...
         if(this.var_1325)
         {
            this.var_1325.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1325 = null;
         }
         this.var_2064 = null;
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_493 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2064 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_326.events.addEventListener(AdEvent.const_516,this.adEventHandler);
            this.var_326.events.addEventListener(AdEvent.const_464,this.adEventHandler);
            this.var_326.events.addEventListener(AdEvent.const_561,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1176 = param2 as IHabboHelp;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_286,this.roomSessionStateEventHandler);
            this.var_16.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionStateEventHandler);
            this.var_16.events.addEventListener(RoomSessionEvent.const_95,this.roomSessionStateEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_222,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_601,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_156,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_500,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_627,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_608,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_630,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_793,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1197,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1300,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_716,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_137,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_526,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_141,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_120,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserDataUpdateEvent.const_126,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_973);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_282:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_793:
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1325 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_542,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_65,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_885,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_783,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_502,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_256,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_954,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_234,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_542 || param1.type == RoomEngineEvent.const_560)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_361:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_941);
               ...
               if(this.var_1602 != RoomDesktop.const_555)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_311,this.var_1602);
               }
               if(this.var_326 != null)
               {
            ...
            case RoomEngineEvent.const_317:
               ...
               break;
            case RoomEngineRoomColorEvent.const_885:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_981);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_311);
            if(_loc3_ != RoomDesktop.const_555)
            {
