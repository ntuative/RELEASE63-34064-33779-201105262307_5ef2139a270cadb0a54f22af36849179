package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1036:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_907 = param1.volume;
         if(this.var_1036 != null)
         {
            this.var_1036.setValue(this.var_907);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_1036 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_811);
         }
         else
         {
