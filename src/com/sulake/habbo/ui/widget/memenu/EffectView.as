package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2246:int = 1000;
      ...
      private var var_997:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_201 = new Timer(this.const_2246);
         this.var_201.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_201.stop();
            this.var_201.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_201 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_188.isActive)
         {
            ...
            this.var_996.width = _loc2_ * this.var_300;
         }
         else
         {
            this.var_996.width = 0;
            this.var_201.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_997 = this._window.findChildByName("effect_hilite");
            this.var_997.visible = false;
         }
         this.setTimeLeft();
         this.var_996 = this._window.findChildByName("loader_bar");
         if(this.var_996 != null)
         {
            this.var_300 = this.var_996.width;
            this.var_201.start();
            this.onUpdate();
         }
