package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1059:int = 150;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2670 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1933 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2672 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1932 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1934 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2669 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2671 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_80 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_312,HabboWindowStyle.const_30,HabboWindowParam.const_66,new Rectangle(0,0,param3.width,param3.height - const_89),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_80);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_40.height - const_89,param3.width,const_89),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_578,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_89),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_579:
               this.var_80.blend += param1 / const_1060;
               this._window.blend += param1 / const_1060;
               ...
               break;
            case const_1098:
               this.var_80.blend -= param1 / const_1059;
               this._window.blend -= param1 / const_1059;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_89;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_89;
            this._region.width = this.var_40.width - this.var_2673;
         }
         if(this.var_80 != null)
         {
            this.var_80.rectangle = this.var_40.rectangle;
            this.var_80.height -= const_89;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2674 == this._window.width)
         {
            return;
         }
         this.var_2674 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2672;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1932;
            barX.disposesBitmap = false;
            this.var_2673 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2670,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1933,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1933,destGripRBitmap);
         ...
         this.var_80.bitmap = this.var_2671;
