package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1369:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_180.state = RoomChatHistoryPulldown.const_285;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1148,HabboWindowStyle.const_46,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_180.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_285);
      }
      ...
      {
         return !!this.var_415 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_180.state == RoomChatHistoryPulldown.const_418 || this.var_180.state == RoomChatHistoryPulldown.const_579;
      }
      ...
      {
         if(!this.var_415 && !this.var_1710)
         {
            this.var_415 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_180.state = RoomChatHistoryPulldown.const_418;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_589;
            }
         }
         if(this.var_180 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_414 > 0 && param2)
         {
            if(this.var_1672)
            {
               if(Math.abs(param1 - this.var_414) <= const_1135)
               {
                  return;
               }
               this.var_1672 = false;
            ...
            if(this.var_415)
            {
               ...
               _loc5_ = (param1 - this.var_414) / this.var_50.height;
               _loc3_ = this.var_589 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_414;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1369 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1673)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_589 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_589 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
