package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_246 = var_46.findChildByTag("catalog");
         if(var_246 != null)
         {
            var_246.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_392)
         {
            this.var_1843 = param1.songId;
         }
         if(param1.songId == this.var_1843)
         {
            this._songName = param1.songName;
            this.var_2564 = param1.songAuthor;
            this.updateNowPlaying(this.var_1843 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2564;
         }
         else
         {
