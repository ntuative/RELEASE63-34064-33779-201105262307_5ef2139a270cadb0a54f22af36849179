package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1568:int = 152;
      
      private static const const_1572:int = 16;
      
      private static const const_664:int = 4;
      
      private static const const_1576:uint = 14342874;
      
      private static const const_1575:uint = 3815994;
      
      private static const const_1574:uint = 2085362;
      
      private static const const_1571:uint = 39616;
      
      private static const const_1570:uint = 10513106;
      
      private static const const_1567:uint = 8734654;
      
      private static const const_1566:uint = 9094430;
      
      private static const const_1573:uint = 6200576;
      
      private static const const_1563:String = "happiness";
      
      private static const const_1564:String = "experience";
      
      private static const const_1569:String = "energy";
      
      private static const const_1565:int = 250;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1563,param1.nutrition,param1.nutritionMax,const_1571,const_1574);
         this.updateStateElement(const_1564,param1.experience,param1.experienceMax,const_1567,const_1570);
         this.updateStateElement(const_1569,param1.energy,param1.energyMax,const_1573,const_1566);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1568,const_1572,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1576);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_545) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_214 && this.var_214.getPetId() == this.var_545)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1703,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1075 + const_1074;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1074;
            }
         }
         this.var_101.height = _loc4_ + const_1075;
         this.updateWindow();
      }
   }
}
