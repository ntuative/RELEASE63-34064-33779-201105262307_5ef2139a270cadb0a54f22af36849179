package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1073:TagListRenderer;
      ...
      private const const_1506:int = 11184810;
      
      private const const_1505:int = 16777215;
      
      private const const_2247:int = 2000;
      
      private const const_2250:int = 50;
      
      private const const_2248:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1073 = new TagListRenderer(param1,this.onTagSelected);
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1043,this.const_2250);
         _loc5_.height = Math.max(_loc5_.height,this.const_2248);
         _loc3_.height = _loc5_.height + this.const_2249;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_335,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_335,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1073.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_105);
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2566 > this.const_2247 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
