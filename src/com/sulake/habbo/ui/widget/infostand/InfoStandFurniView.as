package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_246 = this.var_46.findChildByTag("catalog");
         if(this.var_246 != null)
         {
            this.var_246.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboNavigatorCom_roc_vip_promo_xml":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1185 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_523 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboNavigatorCom_roc_vip_promo_xml",_loc6_);
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_246);
            }
            this.var_246.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_246);
         }
      }
   }
}
