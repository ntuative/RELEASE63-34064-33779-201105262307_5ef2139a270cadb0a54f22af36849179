package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2221:int = 5;
      
      private const const_2222:int = 5;
      ...
      private var var_1115:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1114 = 0;
         this.var_1115 = param2.rectangle.clone();
         this.var_1115.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1115.width)
         {
            return false;
         }
         if(this.var_1114 + param1.height > this.var_1115.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1115.width)
         {
            this._offsetX = 0;
            this.var_1114 += param1.height + this.const_2222;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1114);
         this._offsetX += param1.width + this.const_2221;
         return true;
      }
