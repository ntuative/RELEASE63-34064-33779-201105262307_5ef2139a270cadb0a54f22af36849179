package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1981:uint = 0;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_1981) : uint(this.const_1982);
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(this.var_1021 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1021 % 2) ? uint(this.const_1981) : uint(this.const_1982);
            }
         }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1952);
      }
