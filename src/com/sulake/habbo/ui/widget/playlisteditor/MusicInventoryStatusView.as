package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_437.getValues())
         {
            _loc1_.destroy();
         }
         this.var_437 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_437[param1] as IWindowContainer,0);
         this.var_45 = param1;
      }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_437.add(const_986,_loc1_);
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_530));
         ...
         if(_loc1_ != null)
         {
            this.var_437.add(const_852,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_519));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_437[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
