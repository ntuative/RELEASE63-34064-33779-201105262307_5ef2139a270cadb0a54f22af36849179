   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_631.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_1348;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_104 != null)
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_586;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_104.playButtonState == MusicInventoryGridItem.const_586)
               {
                  this.var_104.playButtonState = MusicInventoryGridItem.const_1238;
            ...
            {
               _loc4_ = this.var_631.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
