package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1186:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_45 != const_633)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_437[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_437[const_725];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_437.add(const_633,_loc1_);
