package com.sulake.habbo.ui.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1434,const_1435,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_399 || this.var_219 == -1 || !this._controller)
         {
            return;
         }
         this.var_399 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_976,this.var_219);
