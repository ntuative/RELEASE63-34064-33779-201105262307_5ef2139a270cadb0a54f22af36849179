package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1476:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_630:DimmerViewColorGrid;
      
      private var var_440:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1434,const_1435,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_630 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_440 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1475 = _loc2_.light;
         if(this.var_440 != null)
         {
            this.var_440.setValue(this.var_1475);
         }
         this.var_531 = this.colors.indexOf(_loc2_.color);
         if(this.var_630 != null)
         {
            this.var_630.setSelectedColorIndex(this.var_531);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1476 = XML(_loc1_.content);
         return this.var_1476;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_440 != null)
         {
            this.var_440.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_630 != null)
         {
            this.var_630.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
