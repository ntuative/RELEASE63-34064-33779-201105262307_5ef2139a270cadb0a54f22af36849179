package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2972:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2972 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_413:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_64,this.var_141,this.var_2271++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_388:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_64,this.var_141,this);
               break;
            case RoomWidgetEnum.const_475:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_64,this.var_141,this._catalog);
               break;
            case RoomWidgetEnum.const_493:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_64,events,this.var_141);
               break;
            ...
            case RoomWidgetEnum.const_487:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_64,this.var_141,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_550:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_64,this.var_141);
               break;
            case RoomWidgetEnum.const_981:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_64,this.var_141);
               break;
            case RoomWidgetEnum.const_135:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_64,this.var_141);
               break;
            ...
            case RoomWidgetEnum.const_125:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_141,this.var_64,this);
               break;
            ...
            case RoomWidgetEnum.const_489:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_64,this.var_141,this._catalog);
               break;
