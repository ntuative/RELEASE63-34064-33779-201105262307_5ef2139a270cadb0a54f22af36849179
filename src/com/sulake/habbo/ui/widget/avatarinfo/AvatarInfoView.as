package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1356:uint = 4281149991;
      
      protected static const const_1353:uint = 4283715916;
      
      protected static const const_1354:uint = 16777215;
      
      protected static const const_1355:uint = 9552639;
      
      private static const const_1380:int = 25;
      ...
      protected var var_2344:int;
      
      protected var var_1357:Boolean;
      
      protected var var_2165:FixedSizeStack;
      
      protected var var_2164:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_481:Timer;
      
      protected var var_2945:int = 3000;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1635 = param5;
         param1.var_2344 = param4;
         param1.var_2166 = param6;
         param1.var_1636 = false;
         param1.var_2946 = 500;
         param1.var_1638 = false;
         param1._blend = 1;
         if(param1.var_1096)
         {
            if(!param1.var_481)
            {
               param1.var_481 = new Timer(param1.var_2945,1);
               param1.var_481.addEventListener(TimerEvent.TIMER_COMPLETE,param1.onTimerComplete);
            }
            param1.var_481.reset();
            param1.var_481.start();
         }
         param1.updateWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_481)
         {
            this.var_481.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_481.reset();
            this.var_481 = null;
         }
         this._disposed = true;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_468));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1638)
         {
            ...
            this._blend = 1 - this.var_1637 / Number(this.var_2946);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1357)
         {
            ...
            if(this.var_1635 == RoomObjectTypeEnum.const_129 || this.var_1635 == RoomObjectTypeEnum.const_562)
            {
            ...
            this.var_2165.addValue(_loc5_);
            _loc6_ = this.var_2165.getMax();
            if(_loc6_ < this.var_2164 - const_998)
            {
               _loc6_ = this.var_2164 - const_998;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2164 = _loc6_;
