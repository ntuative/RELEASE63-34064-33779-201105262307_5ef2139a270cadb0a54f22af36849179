package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1450:IMessageEvent;
      
      private var var_1778:IMessageEvent;
      
      private var var_1777:IMessageEvent;
      ...
      {
         this.var_1450 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1778 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1777 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1450);
         this._connection.addMessageEvent(this.var_1778);
         this._connection.addMessageEvent(this.var_1777);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1450);
               this._connection.removeMessageEvent(this.var_1778);
               this._connection.removeMessageEvent(this.var_1777);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_977,RoomWidgetPlayListModificationMessage.const_948,RoomWidgetPlayListModificationMessage.const_919,RoomWidgetPlayListPlayStateMessage.const_766,RoomWidgetPlayListUserActionMessage.const_685];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetPlayListModificationMessage.const_948:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_919:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_766:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_685:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_234);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_234:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_983,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_936,-1));
            }
         }
      }
