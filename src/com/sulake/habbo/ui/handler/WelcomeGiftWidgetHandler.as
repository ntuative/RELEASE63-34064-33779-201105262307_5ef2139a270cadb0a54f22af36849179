package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_846 = [];
         this.var_846.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_846.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_846)
         {
            return;
         }
         for each(_loc1_ in this.var_846)
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChangeEmailMessage.const_706);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniActionMessage.const_779:
               ...
               break;
            case RoomWidgetChangeEmailMessage.const_706:
