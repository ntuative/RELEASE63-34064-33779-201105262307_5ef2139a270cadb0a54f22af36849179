package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_226.events.addEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_226.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_178,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_106,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_178,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_106,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_608.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_608.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_226 != null)
         {
            this.var_226.events.removeEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_226.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_226 = null;
         }
         this.var_1108 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_558);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_921);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_975);
         _loc1_.push(RoomWidgetFurniActionMessage.const_866);
         _loc1_.push(RoomWidgetFurniActionMessage.const_911);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1234);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_787);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_940);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_821);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1862);
         _loc1_.push(RoomWidgetPetCommandMessage.const_466);
         _loc1_.push(RoomWidgetPetCommandMessage.const_974);
         _loc1_.push(RoomWidgetUserActionMessage.const_615);
         _loc1_.push(RoomWidgetUserActionMessage.const_375);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_937);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_545)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_375 || param1.type == RoomWidgetUserActionMessage.const_615 || param1.type == RoomWidgetUserActionMessage.const_569)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_558:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_921:
            ...
            case RoomWidgetUserActionMessage.const_494:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1260,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_569:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_975:
            ...
            case RoomWidgetFurniActionMessage.const_272:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_866:
            ...
            case RoomWidgetFurniActionMessage.const_911:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1234:
            ...
            case RoomWidgetUserActionMessage.const_375:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_787:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_940:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_821:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_283);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_343);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_429) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_429);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_786) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1185;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_283);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1152);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1308);
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_190)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_562)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_629);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_105)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_139)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_893);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_982;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_800;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1896);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_608.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_608.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_893);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_226 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_392,_loc2_,_loc3_,_loc4_));
         }
      }
