package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_847,RoomWidgetViralFurniMessage.const_883,RoomWidgetViralFurniMessage.const_185];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_847:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_608,RoomSessionViralFurniStatusEvent.const_630];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_608:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_935);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_630:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
