package com.sulake.habbo.ui.handler
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_733);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_733:
            ...
            case RoomWidgetOpenCatalogMessage.const_410:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1318:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1762);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1271:
