package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2000:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_2000 == null)
         {
            ...
            this.var_2000 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_2000.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_211,Tabs.const_289,"-1",MainViewCtrl.const_814);
      }
