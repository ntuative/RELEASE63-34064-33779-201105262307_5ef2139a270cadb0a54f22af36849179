   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_135 == null)
         {
            ...
            this.var_135.addEventListener(WindowEvent.const_50,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_135 != null)
         {
            this.var_135.removeEventListener(WindowEvent.const_50,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_201,Tabs.const_384);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_201,Tabs.const_813);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_201,Tabs.const_384,"" + _loc3_);
         }
         if(this.var_135)
         {
