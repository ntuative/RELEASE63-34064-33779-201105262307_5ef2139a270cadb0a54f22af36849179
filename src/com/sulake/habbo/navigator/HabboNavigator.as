package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_332:MainViewCtrl;
      
      private var var_697:RoomInfoViewCtrl;
      
      private var var_1343:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_332 = new MainViewCtrl(this);
         this.var_697 = new RoomInfoViewCtrl(this);
         this.var_1343 = new RoomCreateViewCtrl(this);
         this.var_2203 = new RoomThumbnailRenderer(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_312,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_332.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_332.startSearch(Tabs.const_211,Tabs.const_419,param1);
         this.var_332.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_332.startSearch(Tabs.const_276,Tabs.const_264);
         this.var_423.getTab(Tabs.const_276).tabPageDecorator.tabSelected();
      }
