package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2036 = IButtonWindow(this.find("bg_tab"));
         this.var_2035 = IButtonWindow(this.find("top_tab"));
         this.var_2037 = IButtonWindow(this.find("obj_tab"));
         this.var_2837 = IWindowContainer(this.find("tile_grid"));
         ...
         Util.setProcDirectly(this.var_2036,this.onBgTabButton);
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_71.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_71.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_2036,this.var_71.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_2035,this.var_71.mode != ThumbnailEditorModel.const_62);
         this.setEnabled(this.var_2037,this.var_71.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_bg",this.var_71.mode == ThumbnailEditorModel.const_37);
         this.refreshEditImg(_loc1_,"edit_top",this.var_71.mode == ThumbnailEditorModel.const_62);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_71.mode == ThumbnailEditorModel.const_36,false);
         if(this.var_71.mode == ThumbnailEditorModel.const_36)
         {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_66,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_578,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_312,HabboWindowStyle.const_46,HabboWindowParam.const_66,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
