package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2203:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2203 = new RoomThumbnailRenderer(param1);
         this.var_1073 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_178,this.var_114);
         if(this.var_114.ownerName != "" && this.var_114.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_178,!!this.var_114.event ? this.getEventCtg(this.var_114.categoryId) : this.getRoomCtg(this.var_114.categoryId));
         this.refreshRoomDesc(this.var_178,this.var_114);
         this.refreshExtraCont();
         this.refreshInfo(this.var_178,"trading_allowed",this.var_114.allowTrading);
         this.refreshInfo(this.var_178,"doormode_doorbell",this.var_114.doorMode == 1);
         this.refreshInfo(this.var_178,"doormode_password",this.var_114.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_178,this.var_114.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1073.refreshTags(_loc1_,this.var_114.tags);
         ...
         this.var_2203.refreshThumbnail(_loc1_,this.var_114.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_211,Tabs.const_289,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
