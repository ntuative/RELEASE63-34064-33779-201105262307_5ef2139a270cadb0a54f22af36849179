package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1232:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,540,"t"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,512,"w"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,396,"x"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,440,"y"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,456,"z"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_48,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1232.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1901 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1901 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_59 = IItemListWindow(this.var_189.findChildByName("item_list"));
         ...
         this.var_1231 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_189.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1231.goBackToInitialState();
         this.var_1231.input.textBackgroundColor = 4294967295;
         this.var_1232 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_66,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1231.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1231.getText();
         var _loc3_:String = "model_" + this.var_1232.name;
