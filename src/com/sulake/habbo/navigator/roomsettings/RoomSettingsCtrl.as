package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_54:RoomSettingsData;
      ...
      {
         this.var_384 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_384));
      ...
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         ...
         {
            this.var_54.controllers.splice(0,0,param2);
            ++this.var_54.controllerCount;
         }
         if(this.var_824)
         {
            this._owner.roomSettingsRefreshNeeded();
      ...
      private function controllerExists(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_54.controllers.length)
         {
            _loc3_ = this.var_54.controllers[_loc2_];
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         --this.var_54.controllerCount;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_54.controllers.length)
         {
            _loc4_ = this.var_54.controllers[_loc3_];
            if(_loc4_.userId == param2)
            {
               this.var_54.controllers.splice(_loc3_,1);
            }
            else
            {
               _loc3_++;
      ...
      {
         if(param1 != this.var_384 || this.var_1265 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1265 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1878)
         {
            this.var_823.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1796)
         {
            this.var_823.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1886)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1769)
         {
            ...
            this.setTagError(this.var_943,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1640)
         {
            this.setTagError(this.var_942,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_943,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_823.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_477,this.onDoorModePasswordUnselect);
         ...
         this.var_823 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1264 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_942 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_943 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1043 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1261 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1258 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1262 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1266 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_822 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1979 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         ...
         this.var_2735 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         ...
         this.var_1977 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1548 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_239 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1263 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1549 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1549.mouseThreshold = 0;
         this.var_1549.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1263.visible = false;
         if(!this.var_1547)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1977.visible = this.var_1547;
         this.populateForm();
         if(this.var_824)
         {
         ...
         else
         {
            ...
            this.var_1548.visible = true;
            this.var_2735.visible = this.var_1547;
            this.var_1259.height = Util.getLowestPoint(this.var_1259) + 4;
         }
         this.var_1549.text = !!this.var_824 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1259.name,this.var_1260.name,this.var_1548.name,this.var_1977.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1978 = false;
         var _loc1_:RoomSettingsData = this.var_54;
         this.var_823.setText(_loc1_.name);
         this.var_1264.setText(_loc1_.description);
         this.var_1043.setText("");
         this.var_1261.setText("");
         ...
         this.setTag(this.var_942,_loc1_.tags[0]);
         this.setTag(this.var_943,_loc1_.tags[1]);
         if(this.var_1258)
         {
            if(_loc1_.allowPets)
            {
               this.var_1258.select();
            }
            else
            {
               this.var_1258.unselect();
            }
         }
         if(this.var_1262)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(this.var_54 == null || this._window == null || this._window.disposed)
         {
            return;
         }
         var _loc2_:SaveableRoomSettingsData = new SaveableRoomSettingsData();
         _loc2_.roomId = this.var_54.roomId;
         _loc2_.name = this.var_823.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_594;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_124)
         {
            _loc8_ = this.var_1043.getText();
            _loc9_ = this.var_1261.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1043.clearErrors();
               this.var_1261.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         var _loc6_:FlatCategory = this.getFlatCategoryByIndex(this.var_54.categoryId,_loc5_.selection);
         _loc2_.categoryId = _loc6_.nodeId;
         var _loc7_:IDropMenuWindow = this._window.findChildByName("maxvisitors") as IDropMenuWindow;
         _loc2_.maximumVisitors = 10 + _loc7_.selection * 5;
         _loc2_.allowPets = this.var_1258.isSelected;
         _loc2_.allowFoodConsume = this.var_1262.isSelected;
         _loc2_.allowWalkThrough = this.var_1266.isSelected;
         _loc2_.hideWalls = this.var_822.isSelected;
         ...
         this.addTag(this.var_943,_loc2_.tags);
         this.clearErrors();
         this.var_1265 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_384);
         if(this.var_54 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_54.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_384]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         if(this.var_239 == null || this.var_239.disposed)
         {
            return;
         }
         Util.hideChildren(this.var_239);
         var _loc1_:IWindow = this.var_239.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_239.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_54.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_239.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            if(this.var_54 != null)
            {
               _loc8_ = false;
               _loc9_ = 0;
               while(_loc9_ < this.var_54.controllers.length)
               {
                  _loc10_ = this.var_54.controllers[_loc9_];
            ...
            _loc5_ = this.var_239.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_239.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_239.findChildByName("flat_controllers_footer"));
            if(this.var_54 != null && this.var_54.controllers.length > 0)
            {
               _loc3_.visible = true;
               _loc7_.visible = true;
               _loc5_.visible = true;
               if(this.var_54.controllerCount > this.var_54.controllers.length)
               {
                  this._navigator.registerParameter("navigator.roomsettings.flatctrls.limitinfo","cnt","" + this.var_54.controllers.length);
                  _loc6_.visible = true;
               }
               Util.moveChildrenToColumn(this.var_239,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_239.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_66,new Rectangle(0,0,100,20)));
      }
      ...
      private function getFlatCtrl(param1:int) : FlatControllerData
      {
         ...
         if(this.var_54 != null)
         {
            for each(_loc2_ in this.var_54.controllers)
            {
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_384));
      }
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent) : void
      {
         ...
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_54.controllers)
         {
            if(_loc3_.selected)
            {
