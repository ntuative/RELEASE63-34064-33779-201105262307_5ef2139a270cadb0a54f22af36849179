package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_430.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_430)
         {
            this.var_430.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_430.reset();
            this.var_430 = null;
         }
         if(this.var_354)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_55 == null)
         {
            this.var_55 = IWindowContainer(this._navigator.getXmlWindow(this.var_1107));
         ...
         this.var_55.x = _loc2_.x + this.var_2416 + param1.width;
