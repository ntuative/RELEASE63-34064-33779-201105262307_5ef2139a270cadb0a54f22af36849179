package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2263:int = 10;
      ...
      private const const_1982:uint = 4.293848814E9;
      
      private const const_1981:uint = 4.294967295E9;
      
      private const const_1538:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_335,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_345,this.onMessageInputFocus);
         }
         this.var_2103 = true;
         this.var_2104 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_331,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_589,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2050 = _loc1_.stuffTypes;
            this.var_868 = _loc1_.boxTypes;
            this.var_870 = _loc1_.ribbonTypes;
            this.var_1342 = this.var_2050[0];
            this.var_400 = this.var_868[0];
            this.var_402 = this.var_870[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_402 < 0)
         {
            this.var_402 = this.var_870.length - 1;
         }
         if(this.var_402 > this.var_870.length - 1)
         {
            this.var_402 = 0;
         }
         if(this.var_400 < 0)
         {
            this.var_400 = this.var_868.length - 1;
         }
         if(this.var_400 > this.var_868.length - 1)
         {
            this.var_400 = 0;
         }
         var _loc1_:int = this.var_868[this.var_400] * 1000 + this.var_870[this.var_402];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2050)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_868[this.var_400]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_870[this.var_402]);
         this._catalog.purchaseProductAsGift(this.var_1625,this.var_1341,this.var_1626,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1625,this.var_1341,this.var_1626);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_227)
         {
            ...
            if(_loc4_.length >= this.const_2263)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2924 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_401 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_401 + 1);
               break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_401) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_869 == null)
         {
            this.var_869 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_284 == null || this.var_869 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_869.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_401) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_401);
         }
         this.var_401 = param1;
         if(this.var_401 < 0)
         {
            this.var_401 = _loc2_.numListItems - 1;
         }
         if(this.var_401 >= _loc2_.numListItems)
         {
            this.var_401 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_401) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1538;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1982) : uint(this.const_1981);
      }
