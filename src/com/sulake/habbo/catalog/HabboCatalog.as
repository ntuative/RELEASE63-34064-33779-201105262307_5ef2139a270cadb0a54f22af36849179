package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1151:IRoomSession;
      ...
      private var var_100:RecyclerLogic;
      ...
      private var var_212:ChargeConfirmationDialog;
      ...
      private var var_2755:Boolean = true;
      
      private var var_2757:Boolean = true;
      
      private var var_1990:Boolean = false;
      
      private var var_2756:GiftWrappingConfiguration;
      
      private var var_1275:ClubGiftController;
      ...
      private var var_832:IPurchasableOffer;
      
      private var var_1557:IDragAndDropDoneReceiver;
      
      private var var_61:PlacedObjectPurchaseData;
      
      private const const_1955:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_84,this.onRoomSessionEvent);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_95,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1727);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_388.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_160,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_195.getKey("client.credits.embed.enabled","ToggleToRandomState") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_831.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_100 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_100.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_100.active && this.mainWindowVisible());
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1955;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1990 = param1.session.isPrivateRoom;
               this.var_1151 = param1.session;
               if(this.var_100 != null)
               {
                  this.var_100.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_95:
               ...
               if(this.var_100 != null)
               {
                  this.var_100.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_100 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1275 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_830 && this.var_830 != "")
         {
            this.var_387.openPage(this.var_830);
            this.var_830 = "";
            this.var_1056 = -1;
         }
         else if(this.var_1056 > -1)
         {
            this.var_387.openPageById(this.var_1056,this.var_1991);
            this.var_1056 = -1;
            this.var_1991 = -1;
            this.var_830 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2755 && this._soundManager != null)
         {
         ...
         {
            this.var_212.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_68,this.var_111.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2757 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1112);
         }
         this.var_2757 = false;
         if(this.var_212 != null && !this.var_212.disposed)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1275.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_100 == null)
         {
            return;
         }
         this.var_100.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_100.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_100.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2756 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_212 == null || this.var_212.disposed)
         {
            this.var_212 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_212.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_831.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_831.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1151 || !this.var_1151.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_198);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1274 && param1.type == RoomEngineObjectEvent.const_160)
         {
            this.resetPlacedOfferData(true);
            if(this.var_832 == null || this.var_832.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_832.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_61 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_832);
            _loc5_ = this.var_1557;
            if(_loc5_ != null)
            {
            ...
            if(this.var_61.roomCategory == this._roomEngine.activeRoomCategory && this.var_61.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_338:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
                  ...
                  case FurniCategory.const_319:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_198);
