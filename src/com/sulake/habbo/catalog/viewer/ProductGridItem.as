package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1044:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_207:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1044).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1044).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_85,MouseCursorType.const_864);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_864);
         }
      }
