package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1455:int = 16763904;
      
      private static const const_1454:int = 13421772;
      
      private static const const_1456:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_92 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         _loc4_ = this.var_259.getWithIndex(this.var_306);
         if(_loc4_ != null)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_259.getWithIndex(this.var_306);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_306;
         if(this.var_306 >= this.var_259.length)
         {
            this.var_306 = 0;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_306);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_306 < 0)
         {
            this.var_306 = this.var_259.length - 1;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_306);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_92 != null)
         {
            ...
            _loc3_ = new Point((this.var_92.width - param1.width) / 2,(this.var_92.height - param1.height) / 2);
            this.var_92.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
