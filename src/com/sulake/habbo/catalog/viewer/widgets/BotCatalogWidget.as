package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      protected var var_485:IItemGridWindow;
      ...
      {
         super(param1);
         this.var_485 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         this.var_1556 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         this.var_485.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = this.var_1556.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         var _loc5_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_94,null,this);
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1988.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1556.getValue(this.var_829.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1988.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1556.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               _loc5_ = _loc3_.productContainer.view;
               _loc6_ = _loc5_.findChildByName("image") as IBitmapWrapperWindow;
               _loc7_ = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_94,null);
               if(_loc7_)
               {
