package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_447:IButtonWindow;
      ...
      {
         super(param1);
         this.var_447 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1174 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_447 != null)
         {
            this.var_447.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_447.disable();
         }
         this.var_1175 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1175 != null)
         {
            this.var_1175.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_447 != null)
         {
            this.var_447.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_191);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_128);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_191);
            this._soundManager.musicController.playSong(this.var_958,HabboMusicPrioritiesEnum.const_191,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1174.text = _loc8_;
            }
         }
         else if(this.var_1174 != null)
         {
            this.var_1174.text = "";
         }
         if(this.var_447 != null)
