package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1962:int = 2;
      
      private const const_2234:int = 40;
      
      private const const_2235:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_517)
         {
            this.var_517.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_517 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_629)
         {
            ...
            this.var_629 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_629)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1962,_loc3_.length,_loc2_);
         if(!this.var_517)
         {
            this.var_517 = new Timer(25);
            this.var_517.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1203 = 0;
         this.populateList();
         this.var_517.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1203 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1203));
            ++this.var_1203;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_629 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_629.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1961);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_109)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2235;
                  break;
               case "search_input":
                  _loc8_ = this.const_2234;
                  break;
               default:
                  return;
            }
