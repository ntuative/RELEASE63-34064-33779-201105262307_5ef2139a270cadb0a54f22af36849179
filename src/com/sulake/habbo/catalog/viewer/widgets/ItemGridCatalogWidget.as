   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_829,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_281,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_987,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_263,this.deActivateScrollbar);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_201.stop();
            this.var_201.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_201 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_485 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1984 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_208)
         {
            this.var_201 = new Timer(25);
            this.var_201.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_201.start();
         }
         else
         {
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_549)
         {
            ++this.var_1840;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1840);
         }
      }
