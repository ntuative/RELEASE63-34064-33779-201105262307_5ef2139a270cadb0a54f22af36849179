package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1063 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1294 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_2017 = new Point(this.var_92.x,this.var_92.y);
         ...
         this.var_2016 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1063.text = _loc4_;
         this.var_1294.text = _loc5_;
         this.var_1063.height = this.var_1063.textHeight + 5;
         this.var_1294.y = this.var_1063.y + this.var_1063.height;
         this.var_1294.height = Math.max(130,this.var_1294.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_549:
                  _loc6_ = this.var_2016.clone();
                  if(this.var_552 != null)
                  {
                     this.var_552.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_552,this.var_1574,this.var_1984);
               ...
               case Offer.const_412:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_220:
                        ...
                        _loc6_ = new BitmapData(this.var_92.width,this.var_92.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_348,AvatarAction.const_514);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_92);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2806)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2806 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_92 != null && true)
         {
            ...
            if(this.var_92.bitmap == null)
            {
               this.var_92.bitmap = new BitmapData(this.var_92.width,this.var_92.height,true,16777215);
            }
            this.var_92.bitmap.fillRect(this.var_92.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_92.width - param1.width) / 2,(this.var_92.height - param1.height) / 2);
            this.var_92.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_92.invalidate();
            this.var_92.x = this.var_2017.x;
            this.var_92.y = this.var_2017.y;
            if(param3 != null)
            {
               this.var_92.x += param3.x;
               this.var_92.y += param3.y;
            }
         }
         if(param2)
         {
