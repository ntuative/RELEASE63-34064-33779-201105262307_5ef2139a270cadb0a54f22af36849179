package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_762,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_209 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1432 && _loc2_ < this.var_209.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_514,this.var_209[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_209 != null && this.var_209.length > 0)
         {
            ...
            this.var_360 = this.var_209[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_514,this.var_360),this.getRaceLocalizationKey(this.var_514,this.var_360));
            }
         }
         return this.getRaceLocalizationKey(this.var_514,this.var_360);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_360 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_514;
         var _loc3_:int = this.var_360;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_360 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
