package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_351:IItemGridWindow;
      ...
      {
         if(!this.var_351.disposed)
         {
            this.var_351.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_351 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_598 = _loc3_.content as BitmapData;
         ...
         this.var_926 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_351.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         this.var_926 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_351.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_924.length,this.var_351.numGridItems]);
         this.var_351.destroyGridItems();
         this.var_220 = null;
         for each(_loc1_ in this.var_924)
         {
            if(_loc1_.length > 0)
            {
               ...
               _loc2_.width = this.var_598.width;
               _loc2_.height = this.var_598.height;
               this.var_351.addGridItem(_loc2_);
               _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_598.width,this.var_598.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_598,this.var_598.rect,new Point(0,0));
               }
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_926.width,this.var_926.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_926,this.var_926.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_351.getGridItemIndex(param1.target as IWindow);
