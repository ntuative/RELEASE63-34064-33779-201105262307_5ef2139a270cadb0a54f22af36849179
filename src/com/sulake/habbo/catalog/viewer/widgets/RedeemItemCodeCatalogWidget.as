package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1083.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1083 = null;
         }
         if(this.var_1082 != null)
         {
            this.var_1082.removeEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
            this.var_1082 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1083 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1083 != null)
         {
            this.var_1083.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1082 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1082 != null)
         {
            this.var_1082.addEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
         }
         return true;
      }
