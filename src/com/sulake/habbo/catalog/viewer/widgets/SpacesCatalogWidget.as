package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1460:String = "default";
      ...
      private var var_1459:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1179 = this.parseElements(_loc2_.walls.pattern);
         this.var_1181 = this.parseElements(_loc2_.landscapes.pattern);
            ...
            switch(_loc9_)
            {
               case "floor":
                  for(_loc10_ in this.var_965)
                  {
                     ...
                     if(this.var_618.indexOf(_loc10_) == -1)
                     {
                        this.var_618.push(_loc10_);
                        this.var_1182.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1179[_loc8_] != null)
                  {
                     this.var_760.push(_loc8_);
                     this.var_1180.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1181[_loc8_] != null)
                  {
                     this.var_759.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1460,this.var_1459,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1180[this.var_434];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1460);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1182[this.var_431];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_435];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1459);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_618[this.var_431];
         var _loc3_:Array = this.var_965[_loc2_];
         if(_loc3_ != null && this.var_433 >= 0)
         {
            _loc11_ = _loc3_[this.var_433];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1182[this.var_431];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_760[this.var_434];
         var _loc6_:Array = this.var_1179[_loc5_];
         if(_loc6_ != null && this.var_432 >= 0)
         {
            _loc13_ = _loc6_[this.var_432];
            if(_loc13_ != null)
            {
               this.var_1460 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1180[this.var_434];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_759[this.var_435];
         var _loc9_:Array = this.var_1181[_loc8_];
         if(_loc9_ != null && this.var_436 >= 0)
         {
            _loc15_ = _loc9_[this.var_436];
            if(_loc15_ != null)
            {
               this.var_1459 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_435];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_113:
               ...
               if(this.var_431 < 0)
               {
                  this.var_431 = this.var_618.length - 1;
               }
               if(this.var_431 >= this.var_618.length)
               {
                  this.var_431 = 0;
               }
               this.var_433 = 0;
               this.var_964 = 0;
               _loc5_ = this.var_618[this.var_431];
            ...
            case const_227:
               ...
               if(this.var_434 < 0)
               {
                  this.var_434 = this.var_760.length - 1;
               }
               if(this.var_434 == this.var_760.length)
               {
                  this.var_434 = 0;
               }
               this.var_432 = 0;
               this.var_963 = 0;
               _loc7_ = this.var_760[this.var_434];
               _loc8_ = this.var_1179[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_963 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_435 < 0)
               {
                  this.var_435 = this.var_759.length - 1;
               }
               if(this.var_435 >= this.var_759.length)
               {
                  this.var_435 = 0;
               }
               this.var_436 = 0;
               this.var_962 = 0;
               _loc9_ = this.var_759[this.var_435];
               _loc10_ = this.var_1181[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_962 = _loc10_.length;
               }
