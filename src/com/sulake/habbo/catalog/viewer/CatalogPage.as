package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1951:String = "ctlg_";
      ...
      private var var_542:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1245:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_542 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1244);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1244);
      }
      ...
      {
         var _loc2_:String = const_1951 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1834:
               if(this.var_1245 == null)
               {
                  this.var_1245 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1245);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1682:
               ...
               break;
            case CatalogWidgetEnum.const_1669:
               this.var_37.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1872:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_542.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_542 != null)
         {
            return this.var_542.dispatchEvent(param1);
         }
         return false;
      }
