package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogObjectMover implements IGetImageListener
   {
      ...
      private static const const_455:String = "CatalogOverlaySprite";
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.const_195:
               ...
               if(this.getIconSprite() == null)
               {
                  ...
                  this.method_6(_loc7_.data.clone());
               }
               this._state = true;
      ...
      private function getIconSprite() : Sprite
      {
         ...
         return _loc1_.getChildByName(const_455) as Sprite;
      }
      ...
      private function releaseOverlaySprite() : void
      {
         ...
         var _loc1_:Sprite = this._mainContainer.desktop.getDisplayObject() as Sprite;
         var _loc2_:Sprite = _loc1_.getChildByName(const_455) as Sprite;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.removeChildAt(0);
         _loc1_.removeChild(_loc1_.getChildByName(const_455));
      }
   }
}
