package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1072:int = 0;
      ...
      {
         return this.var_668 != const_1072;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1995 != RecyclerStatusMessageEvent.const_1276;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_668 == const_459;
      }
      ...
      {
         this.var_668 = const_1073;
         this.var_128 = new Array(const_193);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1314:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1652:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_128.length < const_193)
         {
            return false;
         }
         var _loc1_:int = 0;
