package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1409:Number = 4285716709;
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1927;
            }
         }
      }
      ...
      {
         this.var_59 = navigator.catalog.windowManager.buildFromXML(var_1418) as IItemListWindow;
         if(this.var_59 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1417) as IWindowContainer;
         }
         else
         {
