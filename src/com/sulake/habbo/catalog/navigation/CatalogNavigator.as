package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3006:String = "magic.credits";
      
      private var var_2976:String = "magic.pixels";
      
      private var var_2975:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2976);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2975,true);
      }
