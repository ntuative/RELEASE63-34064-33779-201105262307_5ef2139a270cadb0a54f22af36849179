package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_655:String = "temporary_room";
      ...
      private static const const_1518:String = "tile_cursor";
      
      private static const const_1051:int = -3;
      
      private static const const_1517:String = "selection_arrow";
      ...
      private var var_554:IRoomObjectVisualizationFactory = null;
      ...
      private var var_1003:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_1003 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_554.release(new IIDRoomObjectVisualizationFactory());
            this.var_554 = null;
         }
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_235:
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1001 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc2_ < this.var_312.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_78 || _loc6_ != this.var_79 || !this.var_1002)
                  {
               ...
               if(_loc11_ != null)
               {
                  if(this.var_1002)
                  {
                     _loc11_.screenOffsetX += this.var_1516;
                     _loc11_.screenOffsetY += this.var_1515;
                     this.var_1516 = 0;
                     this.var_1515 = 0;
                  }
               }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_869) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_795) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_763) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_554 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_554;
         }
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_1003 != null)
            {
               this.var_1003.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.initialize(events,this.var_141);
         }
         this.var_2618 = this.var_141.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_326.events.addEventListener(AdEvent.const_561,this.showRoomAd);
         this.var_326.events.addEventListener(AdEvent.const_882,this.onRoomAdImageLoaded);
         this.var_326.events.addEventListener(AdEvent.const_949,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_388;
      }
      ...
      {
         if(this.var_794 == null || this.var_554 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_141 == null || !this.var_2619)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = this.var_371.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_533)
         {
            _loc5_ = this.var_371.remove(_loc4_);
            if(_loc5_ != null)
            {
         ...
         var _loc9_:IRoomInstance = this.method_3(_loc4_,param3,_loc6_,_loc7_,_loc8_,this.getWorldType(param1,param2));
         if(_loc9_ == null)
         {
            return;
         }
      ...
      private function method_3(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         var _loc11_:* = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         var _loc7_:IRoomInstance = this._roomManager.method_3(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_771,1,true);
            _loc12_ = parseInt(this.var_141.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1339,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_367,const_654,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_771,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_872,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_869,_loc15_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1121,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_939,param3);
            ...
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_846,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_198,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_535,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_287);
                        ...
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              ...
                              _loc7_.setNumber(RoomObjectVariableEnum.const_726,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_831,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_726,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1236,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_1052,const_1518,RoomObjectCategoryEnum.const_330);
         if(this.var_141.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1051,const_1517,RoomObjectCategoryEnum.const_330);
         }
         return _loc7_;
      }
      
      public function include(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_367,RoomObjectCategoryEnum.const_78);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_939,param3);
         ...
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_198,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_846,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      {
         var _loc6_:IRoomObjectController = this.include(param1,param2);
         if(_loc6_ == null || _loc6_.getEventHandler() == null)
         {
            return false;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1743,param3,param4,param5);
      ...
      {
         var _loc5_:IRoomObjectController = this.include(param1,param2);
         if(_loc5_ == null || _loc5_.getEventHandler() == null)
         {
            return false;
         }
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1196,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1228,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1223,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_663,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1303;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_872);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_831);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_726);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1236);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1514;
         var _loc9_:int = param3 - this.var_1512;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1002 = true;
               this.var_793 = false;
               this.var_2616 = this.var_1514;
               this.var_2617 = this.var_1512;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1002)
            {
               ...
               {
                  this.var_1516 += _loc8_;
                  this.var_1515 += _loc9_;
                  this.var_793 = true;
               }
            }
         }
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_502,this.var_78,this.var_79,-1,RoomObjectCategoryEnum.const_171));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_69 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_367,const_654);
                     this.var_69.handleRoomObjectEvent(_loc14_,this.var_78,this.var_79);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1513);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1514 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1512 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1513);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1513);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            return this.var_69.modifyRoomObject(this.var_78,this.var_79,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_69.modifyRoomObjectData(this.var_78,this.var_79,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            ...
            {
               return this.var_69.modifyWallItemData(this.var_78,this.var_79,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_69.deleteWallItem(this.var_78,this.var_79,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_771) != 0)
         {
            return false;
         }
         if(this.var_69 != null)
         {
            return this.var_69.initializeRoomObjectInsert(this.var_78,this.var_79,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_69 != null)
         {
            this.var_69.cancelRoomObjectInsert(this.var_78,this.var_79);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1051,RoomObjectCategoryEnum.const_330);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1052,RoomObjectCategoryEnum.const_330);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc9_ != null && _loc9_.getModelController() != null && _loc5_)
         {
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_283,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_404,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_851,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1152,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1308,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_786,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_256,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc8_ != null && _loc8_.getModelController() != null)
         {
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_283,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_404,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1303,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_786,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_256,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1220) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1219);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_916,_loc5_);
                  }
               }
            }
         }
         ...
         var _loc8_:IRoomObjectController = this.include(param1,param2);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_411,this.var_78,this.var_79,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_69 != null)
         {
            this.var_69.handleRoomObjectEvent(param1,this.var_78,this.var_79);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_209);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_198,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_655);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.method_3(const_655,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_209,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_828,int(param2));
               }
               break;
         ...
         if(!this.isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1146,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_78,this.var_79,const_367,RoomObjectCategoryEnum.const_78,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_655);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1146);
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_424,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1178,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1143,param1.adWarningR,true);
            _loc3_ = this.include(param1.roomId,param1.roomCategory);
            if(_loc3_ == null)
            {
               return;
            }
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1230,RoomObjectVariableEnum.const_424,param1.clickUrl);
      ...
      {
         var _loc4_:* = null;
         var _loc2_:IRoomObjectController = this.include(param1.roomId,param1.roomCategory);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         switch(param1.type)
         {
            case AdEvent.const_882:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1156,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_949:
