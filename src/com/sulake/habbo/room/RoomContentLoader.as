package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_790:String = "RCL_LOADER_READY";
      
      private static const const_370:String = "RCL_PUBLICROOM_";
      ...
      private static const const_463:String = "place_holder";
      
      private static const const_682:String = "wall_place_holder";
      
      private static const const_681:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_463;
      
      private static const const_683:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1109:String = "selection_arrow";
      ...
      private var var_1091:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1090:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2936 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2937 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1034)
         {
            return;
         }
         this.var_1628 = param1;
         this.var_2935 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2933 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_875.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_703.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_702.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_702.remove(_loc7_);
               this.var_702.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2934)
         {
            ...
            {
               this.var_1628.dispatchEvent(new Event(const_790));
            }
         }
      }
      ...
      {
         return [const_463,const_682,const_681,const_683,TILE_CURSOR,const_1109];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_478.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_703.getValue(param1) as String;
      ...
      {
         return this.var_1091.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1090[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_703.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_875.getValue(param1) != null)
         {
            return this.var_875.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_218 != null && this.var_218.hasWorldType(const_370 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_241 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_702.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_218 = this.var_1627.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_794,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2936.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1767);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2937.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1090.add(_loc6_,_loc3_);
         }
      }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_874.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_874.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_874.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_554.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_370 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_370 + param1) == RoomObjectCategoryEnum.const_78)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_218.getWorldHeightScale(const_370 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_218 != null)
         {
            return this.var_218.getWorldScale(const_370 + param1);
         }
         return 32;
      }
