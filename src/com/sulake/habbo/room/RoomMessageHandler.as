package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1493:int = -1.0E9;
      
      private var var_781:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_781 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_781.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_781.objectData);
            this.var_781.objectData = null;
         }
         else
         {
            this.var_781.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_781.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_781.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_872);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1133:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1288:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:IRoomObject = this.var_12.include(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1281,_loc3_.status);
         }
      }
