package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_997:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_722 != _loc2_)
         {
            ...
            if(_loc3_ * const_447 > const_997)
            {
               this.var_1017 = const_997 / _loc3_;
            }
            else
            {
               this.var_1017 = const_447;
            }
            this.var_1388 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_722 && param1 >= this.var_1388 + this.var_1017)
            {
               _loc3_ = param1 - this.var_1388;
               _loc4_ = _loc3_ / this.var_1017;
               _loc5_ = 1;
               if(this.var_722 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1388 = param1 - (_loc3_ - _loc4_ * this.var_1017);
            }
         }
      }
   }
