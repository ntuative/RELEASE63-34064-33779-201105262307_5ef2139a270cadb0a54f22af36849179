package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_218,RoomObjectRoomAdEvent.const_336,RoomObjectRoomAdEvent.const_315];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_424,"");
         _loc2_.setString(RoomObjectVariableEnum.const_819,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_557,Number(false));
         this.var_807 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1573 > 0 && param1 > this.var_1573)
         {
            this.adDelayTimeout();
            this.var_1573 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1230:
                  _loc2_.setString(RoomObjectVariableEnum.const_424,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_819,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_557,Number(true));
                  this.var_1573 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1339);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_557,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_590)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_819);
