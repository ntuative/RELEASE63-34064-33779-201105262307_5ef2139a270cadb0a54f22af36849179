package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1971:int = 255;
      
      private var var_1546:uint = 16777215;
      
      private var var_1968:int = 255;
      
      private var var_1254:uint = 16777215;
      
      private var var_1969:int = 255;
      
      private var var_1253:int = 0;
      
      private var var_1970:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_612,RoomObjectMouseEvent.const_161];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1188,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_929,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_724,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_835,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1253)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1971;
            if(_loc2_ - this.var_1253 >= this.var_1970)
            {
               _loc3_ = this.var_1254;
               _loc4_ = this.var_1969;
               this.var_1253 = 0;
            }
            else
            {
               _loc7_ = this.var_1546 >> 16 & 255;
               _loc8_ = this.var_1546 >> 8 & 255;
               _loc9_ = this.var_1546 & 255;
               _loc10_ = this.var_1254 >> 16 & 255;
               _loc11_ = this.var_1254 >> 8 & 255;
               _loc12_ = this.var_1254 & 255;
               _loc13_ = (_loc2_ - this.var_1253) / this.var_1970;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1968 + (this.var_1969 - this.var_1968) * _loc13_;
               this._color = _loc3_;
               this.var_1971 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_929,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_939:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_535:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_287)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_916:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1125,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1228:
               param2.setNumber(RoomObjectVariableEnum.const_724,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1196:
               param2.setNumber(RoomObjectVariableEnum.const_835,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_663:
               param2.setNumber(RoomObjectVariableEnum.const_1149,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1223:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1287,int(param1.bgOnly));
         this.var_1546 = this._color;
         this.var_1968 = this.var_1971;
         this.var_1254 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_626,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1853,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1777,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1734,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_626,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_253 || _loc12_ == RoomPlaneData.const_420)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
