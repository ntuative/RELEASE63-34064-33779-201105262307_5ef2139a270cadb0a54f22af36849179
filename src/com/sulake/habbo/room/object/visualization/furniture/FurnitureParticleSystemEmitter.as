package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1754:String = "cone";
      
      public static const const_1809:String = "plane";
      
      public static const const_1651:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_952 = 0;
         this.var_949 = false;
         this.init(0,0,0,this._direction,this.var_2452,this.var_951,this.var_2453,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1165.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_949 = true;
         if(this.var_952 < this.var_1440)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2449)
         {
            switch(this.var_2448)
            {
               case const_1754:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1165.length);
         return this.var_1165[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_952 < this.var_1440)
         {
            if(this.age % this.var_2451 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_952 < this.var_1440)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_256) * this.x - (1 - this.var_256) * this.lastX;
            this.y = (2 - this.var_256) * this.y - (1 - this.var_256) * this.lastY + this.var_1767 * this.var_951 * this.var_951;
            this.z = (2 - this.var_256) * this.z - (1 - this.var_256) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_357)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_256) * _loc2_.x - (1 - this.var_256) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_256) * _loc2_.y - (1 - this.var_256) * _loc2_.lastY + this.var_1767 * this.var_951 * this.var_951;
            _loc2_.z = (2 - this.var_256) * _loc2_.z - (1 - this.var_256) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
