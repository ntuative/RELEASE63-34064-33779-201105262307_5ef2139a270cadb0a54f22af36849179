package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1544:String = "head";
      
      private static const const_658:int = 1;
      
      private static const const_1058:int = 1000;
      
      private static const const_1545:String = "pet_experience_bubble_png";
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1015 = [];
         super();
         while(this.var_125.length < ANIMATION_INDEX_COUNT)
         {
            this.var_125.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_125 != null)
         {
            ...
            {
               _loc2_ = this.var_125[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1545) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2661)
            {
               this.var_2661 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_154)
         {
            ...
            this.var_2084 = _loc3_.getNumber(RoomObjectVariableEnum.const_436) > 0;
            ...
            this.var_1533 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2597 = _loc3_.getNumber(RoomObjectVariableEnum.const_842);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_828);
            if(_loc9_ != this.var_1925)
            {
               this.var_1925 = _loc9_;
               this.var_2662 = this.var_1925.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_380 != null)
         {
            ...
            if(this.var_1533 > 0)
            {
               _loc2_ = param1 - this.var_1533;
               if(_loc2_ < const_1058)
               {
                  this.var_380.alpha = int(Math.sin(_loc2_ / const_1058 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_658;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1534 = false;
         var _loc1_:int = this.var_125.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_125[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_125.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_125[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2662);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_658)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_658))
            {
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_94,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1544)
            {
