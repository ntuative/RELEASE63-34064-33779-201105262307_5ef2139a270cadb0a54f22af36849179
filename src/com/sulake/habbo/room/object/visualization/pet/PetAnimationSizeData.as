package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_842 = param1.@defaultPosture;
         }
         else
         {
            this.var_842 = null;
         ...
         if(this.var_678.getValue(this.var_842) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_841.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_841.getValue(param1) == null)
         {
            return const_701;
         }
         return int(this.var_841.getValue(param1));
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_841.length)
         {
            return this.var_841.getKey(param1);
         }
         return null;
      }
