package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1089:int = 13421772;
      
      private static const const_1088:int = 10066329;
      
      private static const const_1091:int = 10066329;
      
      public static const const_1778:int = 16777215;
      
      public static const const_1639:int = 13421772;
      ...
      private var var_1460:String = null;
      
      private var _floorType:String = null;
      
      private var var_1459:String = null;
      
      private var _floorThicknessMultiplier:Number = NaN;
      
      private var var_1563:Number = NaN;
      
      private var var_2042:String = null;
      
      private var var_1313:uint = 16777215;
      
      private var var_2849:int = 255;
      
      private var var_2845:int = 255;
      
      private var var_2846:int = 255;
      ...
      private const const_2262:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1563))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1563;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1188);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1121);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_258)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1747)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_73,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1937 + this.const_2262 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_392.length)
            {
               _loc11_ = this.var_677[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_392[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2043)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2846 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2845 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2849 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1779)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1622 || _loc3_.y != this.var_2848 || _loc3_.z != this.var_2847 || param1.scale != this.var_2041))
            {
               this.var_1622 = _loc3_.x;
               this.var_2848 = _loc3_.y;
               this.var_2847 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1125);
            if(_loc3_ != this.var_2042)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2042 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_929));
            if(_loc4_ != this.var_1313)
            {
               this.var_1313 = _loc4_;
               this.var_2846 = this.var_1313 & 255;
               this.var_2845 = this.var_1313 >> 8 & 255;
               this.var_2849 = this.var_1313 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1287));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_198);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_724));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_835));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_692));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1149);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1280);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1563))
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_392;
         if(this.var_392.length == 0)
         {
            _loc6_ = this.var_148;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_392.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_392.push(_loc12_);
                        this.var_677.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1312;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_558.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_558.maskCount)
         {
            _loc10_ = this.var_558.getMaskType(_loc8_);
            _loc11_ = this.var_558.getMaskLocation(_loc8_);
            _loc12_ = this.var_558.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_73 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_287)
                              {
