package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1487:ConversationView;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1487.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_145.getXmlWindow("main_window"));
         ...
         this.var_986 = new ConversationsTabView(this.var_145,this.var_17);
         this.var_986.refresh();
         this.var_985 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_985.addEventListener(WindowKeyboardEvent.const_196,this.onMessageInput);
         this.var_1487 = new ConversationView(this.var_145,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_838,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1153,true);
         this.var_17.center();
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_985.text = "";
         this.var_145.conversations.addMessageAndUpdateView(new Message(Message.const_801,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
