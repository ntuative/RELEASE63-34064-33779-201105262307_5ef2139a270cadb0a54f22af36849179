package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1333:Function;
      
      private var var_1334:Function;
      
      private var var_856:IAssetLibrary;
      
      private var var_1332:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_856.loadAssetFromFile("hotel_view_banner_" + this.var_1332,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_873));
            }
