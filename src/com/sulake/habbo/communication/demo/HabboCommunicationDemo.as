package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2742:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_666 = param1;
            this.var_57.initConnection(HabboConnectionType.const_280);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_95,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_57 && this.var_141 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_666 = this.var_141.getKey("sso.ticket",null);
         this.var_1985 = this.var_141.getKey("flash.client.url","");
         this.var_2741 = this.var_141.getKey("external.variables.txt","");
         if(this.var_241 == null)
         {
            this.var_241 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_497,this.onInitConnection);
            }
            else
            {
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1119;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_280);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_782);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2742 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_93:
               ...
               this.var_1551 = _loc4_;
               this.var_241.loadBannerImage(_loc7_ + "?token=" + this.var_1551,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1119:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1895:
               this.var_1049 = this.generateRandomHexString(30);
               this.var_548 = new DiffieHellman(new BigInteger(this.var_141.getKey("connection.development.prime"),16),new BigInteger(this.var_141.getKey("connection.development.generator"),16));
               this.var_548.init(this.var_1049);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2742);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1985,this.var_2741));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1989,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2740)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1551);
