package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1891:uint = 1;
      
      public static const const_1713:uint = 2;
       
      
      private var var_1613:IProtocolEncoder;
      ...
      {
         super();
         this.var_1613 = new WedgieEncoder();
