package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1117:AvatarEditorHandler;
      ...
      private var var_900:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_198)
         {
            ...
            this.var_588["null"] = new FigureData(this);
            this.var_588["null"] = new FigureData(this);
            _loc2_ = this.var_588["null"];
            _loc3_ = this.var_588["null"];
            _loc2_.loadAvatarData(const_1366,FigureData.const_82);
            _loc3_.loadAvatarData(const_1367,FigureData.FEMALE);
            this.var_107 = new Map();
            this.var_492 = new Map();
            this.var_107.add(AvatarEditorFigureCategory.const_900,new BodyModel(this));
            this.var_107.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_107.add(AvatarEditorFigureCategory.const_269,new TorsoModel(this));
            this.var_107.add(AvatarEditorFigureCategory.const_969,new LegsModel(this));
            ...
            this.var_492.add(AvatarEditorSideCategory.const_107,new WardrobeModel(this));
            this.var_492.add(AvatarEditorSideCategory.const_556,new ClubPromoModel(this));
            this.var_198 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_588[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_900.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_900.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_247 == null)
            {
               this.var_247 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_247.addChild(this._view.window);
               if(param5)
               {
                  this.var_247.center();
               }
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_900);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_492.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_493 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_900 = this.var_493.getFigureData(AvatarType.const_118);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1117 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_588[this.var_966];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1116 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1368)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_493.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_493.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1355.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1757)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1116 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1355.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1116 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_492.getValue(AvatarEditorSideCategory.const_107);
      }
