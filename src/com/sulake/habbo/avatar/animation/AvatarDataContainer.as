package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2830:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2034 = parseInt(param1.@ink);
         ...
         this.var_2828 = parseInt(_loc3_,16);
         ...
         this.var_871 = new ColorTransform(this.var_1796,this.var_1795,this.var_1794,this._alphaMultiplier);
         this.var_1302 = this.generatePaletteMapForGrayscale(this.var_2828,this.var_2829);
      }
