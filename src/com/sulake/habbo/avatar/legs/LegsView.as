   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.const_292,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.const_271,_windowManager,_assetLibrary);
         }
         else
         {
