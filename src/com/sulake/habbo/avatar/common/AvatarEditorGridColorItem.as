package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_598 = _loc4_.content as BitmapData;
         ...
         this.var_926 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_598.width,this.var_598.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_598,this.var_598.rect,new Point(0,0));
         }
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_926.width,this.var_926.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_926,this.var_926.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_1032)
            {
               switch(this.var_1032.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_45:
                     _loc4_.style = HabboIconType.const_789;
                     _loc4_.visible = true;
                     break;
