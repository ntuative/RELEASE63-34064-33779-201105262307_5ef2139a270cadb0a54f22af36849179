package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_903:int = 3;
      
      private var var_422:AssetLoaderStruct;
      ...
      private const const_2223:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_422 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_902 = new Timer(this.const_2223,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_422)
         {
            this.var_422.addEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_422.addEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_422)
         {
            this.var_422.removeEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_422.removeEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_903);
            if(this.var_1396.indexOf("?") > 0)
            {
               _loc2_ = this.var_1396 + "&retry=" + this.var_903;
            }
            else
            {
               _loc2_ = this.var_1396 + "?retry=" + this.var_903;
            ...
            this.var_422 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2270,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1683)
         {
            this.var_1122.push([param1,param2]);
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_725.length > 0 && this.var_726.length < this.const_1807)
         {
            _loc1_ = this.var_725[0];
            _loc1_.startDownloading();
            this.var_726.push(this.var_725.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_725.indexOf(param1) == -1 && this.var_726.indexOf(param1) == -1)
         {
