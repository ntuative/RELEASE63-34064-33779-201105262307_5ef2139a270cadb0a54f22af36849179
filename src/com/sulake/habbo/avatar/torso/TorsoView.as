   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.const_233,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.const_202,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_71,FigureData.const_270,_windowManager,_assetLibrary);
         }
         else
         {
