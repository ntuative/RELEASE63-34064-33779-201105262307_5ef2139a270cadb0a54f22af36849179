package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_251:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1412);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_693);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1412 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_94)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_693);
                  _loc20_ = this.var_93;
                  _loc21_ = 1;
                  switch(this.var_93)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_693);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_693);
                  _loc21_ = this.var_93;
                  _loc22_ = 1;
                  switch(this.var_93)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_566 = this.var_566 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_425:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1813:
                  case AvatarAction.const_1698:
                  case AvatarAction.const_1720:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_928);
         this.getCache().resetBodyPartCache(this.var_928);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1413 = this._structure.sortActions(this.var_339);
         ...
         {
            this.var_736 = this._structure.getCanvasOffsets(this.var_1413,this._scale,this.var_93);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1413)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_389)
               {
                  this.var_927 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1224 = _loc4_.id;
                     this.var_1727 = _loc4_.breed;
                     break;
                  }
               }
            }
