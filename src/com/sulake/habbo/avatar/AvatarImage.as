package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1405:String = "Default";
      
      private static const const_1406:int = 2;
      
      private static const const_1407:String = AvatarSetType.const_35;
      ...
      protected var var_736:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_251:AvatarImageCache;
      ...
      private var var_928:IActiveActionData;
      ...
      private var var_2097:Array;
      
      private var var_2915:int = -1;
      
      private var var_2916:String = null;
      
      private var var_2914:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_620 = param3;
         this.var_251 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1407,const_1406);
         this.var_339 = new Array();
         this.var_928 = new ActiveActionData(AvatarAction.const_428);
         this.var_928.definition = this._structure.getActionDefinition(const_1405);
         this.resetActions();
      ...
      {
         param2 += this.var_1726;
         if(param2 < AvatarDirectionAngle.const_1118)
         {
            param2 = AvatarDirectionAngle.const_323 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_323)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_693,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_283.length == 1 && this.var_93 == this.var_1924)
         {
            return this.var_93 + this.var_566 + this.var_693 % 4;
         }
         if(this.var_283.length == 2)
         {
            for each(_loc1_ in this.var_283)
            {
               ...
               {
                  return this.var_93 + this.var_566 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_693 % 11;
                  return this.var_93 + "_" + this.var_1924 + this.var_566 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2915 || param2 != this.var_2916 || param1 != this.var_2914)
         {
            this.var_2915 = param3;
            this.var_2916 = param2;
            this.var_2914 = param1;
            this.var_2097 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1377 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1377)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_693);
         ...
         if(this.var_582 != null)
         {
            if(this.var_582.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_582.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_693);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_339.push(new ActiveActionData(param1,param2,this.var_693));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_290 = this.var_928;
         this.var_290.definition = this.var_928.definition;
         this.resetBodyPartCache(this.var_928);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_566 = "";
         this.var_283 = this._structure.sortActions(this.var_339);
         if(this.var_283 == null)
         {
            this.var_736 = new Array(0,0,0);
            if(this.var_1339 != "")
            {
               _loc1_ = true;
               this.var_1339 = "";
         ...
         {
            this.var_736 = this._structure.getCanvasOffsets(this.var_283,this._scale,this.var_93);
            for each(_loc4_ in this.var_283)
            {
               this.var_566 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_346)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1621 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1621 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1339 != this.var_566)
            {
               _loc1_ = true;
               this.var_1339 = this.var_566;
            }
         }
         this.var_1414 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_283)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_927 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1726 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_360 || _loc1_.actionType == AvatarAction.const_277 || _loc1_.actionType == AvatarAction.const_389)
               {
                  this.var_927 = true;
               }
            }
