package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private var var_361:IBitmapWrapperWindow;
      ...
      private function createView() : void
      {
         ...
         this.var_361 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this.var_620 && this.var_1463)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_94,this.var_966,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_854));
         ...
         if(this.var_361)
         {
            if(this.var_361.bitmap)
            {
               this.var_361.bitmap.dispose();
            }
            this.var_361.bitmap = new BitmapData(this.var_361.width,this.var_361.height,true,0);
            _loc7_ = (this.var_361.width - _loc1_.width) / 2;
            _loc8_ = (this.var_361.height - _loc1_.height) / 2;
            this.var_361.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_966 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1793,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_620)
               {
                  this._controller.loadAvatarInEditor(this.var_620,this.var_966,this._controller.clubMemberLevel);
               }
         }
      }
