package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_1758:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2062 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2062 = 15;
         }
         this.var_2063 = this._window.height;
         this.var_1600 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_579:
               ...
               _loc2_ = Number(this.var_1323) / Number(this.var_1075["time_fade_in"]);
               if(this.var_1323 > int(this.var_1075["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1097:
               ...
               if(this.var_1599 > int(this.var_1075["time_display"]) && !this.var_2061)
               {
                  this.startFadeOut();
               }
               break;
            case const_1098:
               ...
               _loc3_ = 1 - Number(this.var_1324) / Number(this.var_1075["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1324 > int(this.var_1075["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2062;
         if(this._window.height < this.var_2063)
         {
            this._window.height = this.var_2063;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1758;
         this._window.y = this.var_1600;
      }
