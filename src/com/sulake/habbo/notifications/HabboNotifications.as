package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1393:String = "pixelbalance";
      
      private static const const_1390:String = "badges";
      
      private static const const_1395:String = "selectbadge";
      
      private static const const_1392:String = "inventory";
      
      private static const const_1394:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1396:String = "friendlist";
      
      private static const const_1391:String = "pet_inventory";
      ...
      private var var_349:HabboNotificationViewManager;
      ...
      private var var_915:ClubGiftNotification;
      
      private var var_916:ClubEndingNotification;
      
      private var var_917:ClubPromoNotification;
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_349)
         {
            this.var_349.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1405[_loc3_.data.badgeCode] = new AchievementNotification(_loc3_.data.badgeCode,_loc3_.data.achievementID,_loc3_.data.level,_loc3_.data.points,_loc3_.data.levelRewardPoints,_loc3_.data.levelRewardPointType,_loc3_.data.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_388);
      }
      
      private function isStandaloneAchievementListEnabled() : Boolean
      {
         return this._config.getKey("standaloneAchievementList.enabled","ToggleToRandomState") == "true";
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1405[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1405[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_349 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_914["styles"],this.var_914["view"]);
         ...
         registerUpdateReceiver(this.var_349,1);
         registerUpdateReceiver(this,2);
         this.var_388.events.addEventListener(BadgeImageReadyEvent.const_106,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_388.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1115,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1115,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1750,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_714,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_493.createAvatarImage(param2,AvatarScaleType.const_57);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1831,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1314)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1799,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1815)
         {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_917 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_349.isSpaceAvailable() && this.var_1139.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_349.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1391:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_123);
               }
               break;
            case const_1394:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_349.replaceIcon(param1);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_493.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_57);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2327)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_714,null);
            this.var_2327 = true;
      ...
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_628)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_915 && this.var_915.visible)
         {
            return;
         }
         this.var_915 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_714,_loc6_);
      }
   }
}
