package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1002:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1404:String = "sendAccessTokenToServer";
      
      private static const const_1403:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1404,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1403,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1002);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1002);
         }
      }
