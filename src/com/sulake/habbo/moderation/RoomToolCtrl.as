package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1148:IDropMenuWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_384));
         Logger.log("BEGINNING TO SHOW: " + this.var_384);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_384);
         if(param1.flatId != this.var_384)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_384);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1148 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1148);
         this.var_1148.procedure = this.onSelectTemplate;
         this.var_990 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_942,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_657 || this.var_549.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_990.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1687,_loc2_,this.var_549.text,"",""));
         if(this.var_1490.isSelected || this.var_1491.isSelected || this.var_990.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1490.isSelected,this.var_1491.isSelected,this.var_990.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1830);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1929);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1148.selection];
         if(_loc3_ != null)
         {
            this.var_657 = false;
