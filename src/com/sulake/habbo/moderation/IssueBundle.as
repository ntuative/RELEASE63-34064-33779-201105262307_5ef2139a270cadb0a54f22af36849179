package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2201 = param2.pickerUserId;
         this.var_2282 = param2.pickerUserName;
         this.var_1381 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1124 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1125;
         }
         if(this.var_728 == null || param1.timeStamp < this.var_728.timeStamp)
         {
            this.var_728 = param1;
         }
         if(this.var_729 == null || param1.priority > this.var_729.timeStamp)
         {
            this.var_729 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_729;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_728;
         if(_loc2_ == null)
         {
