package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_992:Array = [];
      
      private static var var_1845:int = 200;
      ...
      {
         this.var_780 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1696;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_992.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_780.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_992.length < var_1845)
         {
            ...
            param1.width = this.var_780.width;
            param1.height = this.var_780.height;
            var_992.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1492)
         {
