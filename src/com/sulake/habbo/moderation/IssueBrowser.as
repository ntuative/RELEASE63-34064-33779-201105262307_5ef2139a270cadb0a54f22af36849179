package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2229:String = "my_issues";
      
      private const const_2230:String = "open_issues";
      
      private const const_2228:String = "picked_issues";
      
      private const const_2266:String = "closed_issues";
      ...
      private var var_352:IIssueBrowserView;
      
      private var var_1730:IIssueBrowserView;
      
      private var var_1732:IIssueBrowserView;
      
      private var var_1731:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_352.view.width = this.var_253.container.width;
         this.var_352.view.height = this.var_253.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2229:
               ...
               {
                  this.var_1730 = new MyIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1730;
            case this.const_2230:
               if(this.var_1732 == null)
               {
                  this.var_1732 = new OpenIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1732;
            case this.const_2228:
               if(this.var_1731 == null)
               {
                  this.var_1731 = new PickedIssuesView(this.issueManager,this,this.var_253.container);
               }
