package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1066:int = 86400;
      
      private static const const_1065:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1064)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1067)
         {
            return Math.round(param1 / const_1064) + " mins ago";
         }
         if(param1 < 2 * const_1066)
         {
            return Math.round(param1 / const_1067) + " hours ago";
         }
         if(param1 < 2 * const_1065)
         {
            return Math.round(param1 / const_1066) + " days ago";
         }
         return Math.round(param1 / const_1065) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1216,this._data.userId),this._callerFrame,this.var_1249,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1553),this._callerFrame,this.var_1249,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1553),this._callerFrame,this.var_1249,false,true);
      }
