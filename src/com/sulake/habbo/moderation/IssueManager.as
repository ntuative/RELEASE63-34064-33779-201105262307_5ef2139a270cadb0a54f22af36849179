package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1129:String = "issue_bundle_open";
      
      public static const const_808:String = "issue_bundle_my";
      ...
      private var var_663:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_663 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1257 = [];
         this.var_1256 = [];
         this.var_1041 = new Map();
         this.var_2725 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1973 = new Timer(const_1829,0);
         this.var_1973.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1973.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1257 = this.var_1257.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1256 = this.var_1256.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1226);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1042.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_1042.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1823)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_110)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1042.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2724++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1042.add(param1.issueId,_loc2_);
         ...
         if(this.var_1257.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_808);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1256.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2725);
            }
         }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1042.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_110.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
