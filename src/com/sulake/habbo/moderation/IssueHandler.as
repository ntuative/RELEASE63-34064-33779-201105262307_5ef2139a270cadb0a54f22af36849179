package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1138:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_503 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_1138 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         ...
         {
            this.var_1138.load(_loc4_,this.var_159.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_67 != null && this.var_67.issueManager != null && this.var_159 != null)
         {
            this.var_67.issueManager.removeHandler(this.var_159.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_159.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_159.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_159.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.releaseBundle(this.var_159.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_67,WindowTracker.const_1286,_loc2_),this._window,false,false,true);
      }
