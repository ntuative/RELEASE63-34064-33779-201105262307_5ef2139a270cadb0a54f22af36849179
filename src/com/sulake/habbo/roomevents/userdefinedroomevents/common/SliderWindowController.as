package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_967);
         }
      ...
      {
         return int(this.var_1737 * (Number(param1 - this._minValue) / (this.var_1188 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1737 * (this.var_1188 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_968 || param1.type != WindowEvent.const_393)
         {
            return;
         }
         if(this.var_623 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_623) * this.var_623;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_623 != 0)
            {
               _loc3_ = this.var_967 + this.var_623;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_742 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_742.width,this.var_742.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_742,this.var_742.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_743 != null)
            {
               ...
               this.var_1737 = _loc1_.width - _loc2_.width;
            }
         }
