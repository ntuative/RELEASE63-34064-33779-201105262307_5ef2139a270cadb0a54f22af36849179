package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_84 = param2;
         this.var_1150 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1150.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1150.setValue(1);
         this.var_1149 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1149.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1149.setValue(50);
      }
