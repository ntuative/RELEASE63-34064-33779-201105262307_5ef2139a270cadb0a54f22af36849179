package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2001 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1287 = this.var_2001.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1287)
         {
            this.var_1287.procedure = this.onButtonClick;
         }
         this.var_1286 = this.var_2001.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1286)
         {
            this.var_1286.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_272 >= this.var_64.length - 1)
         {
            this.var_1286.disable();
         }
         else
         {
            this.var_1286.enable();
         }
         if(this.var_272 <= 0)
         {
            this.var_1287.disable();
         }
         else
         {
            this.var_1287.enable();
         }
      }
      ...
      {
         ++this.var_272;
         this.var_272 = Math.min(this.var_272,this.var_64.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_64[this.var_272][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_64[this.var_272][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_64[this.var_272][1]).value;
