package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1535:int = 2;
      ...
      private var var_1928:TriggerConfs;
      
      private var var_1929:ActionTypes;
      
      private var var_1927:ConditionTypes;
      
      private var var_268:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_810:RoomObjectHightLighter;
      
      private var var_190:UserDefinedRoomEventsHelp;
      
      private var var_1240:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1928 = new TriggerConfs();
         this.var_1929 = new ActionTypes();
         this.var_1927 = new ConditionTypes();
         this.var_268 = new Dictionary();
         super();
         this.var_84 = param1;
         this.var_810 = new RoomObjectHightLighter(param1);
         this.var_190 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_268[param1])
         {
            delete this.var_268[param1];
            this.var_810.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_268[param1] = param2;
            this.var_810.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1240 = new SliderWindowController(this.var_84,IWindowContainer(this.find(this.var_53,"delay_slider_container")),this.var_84.assets,0,20,1);
         this.var_1240.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1240.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_810.hideAll(this.var_268);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1240.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_190.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1535) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1535 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1928);
         this.refreshConfigureElement(this.var_1929);
         this.refreshConfigureElement(this.var_1927);
