package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_95,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_593,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_314));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_697));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_52.getValue(InventorySubCategory.const_1257));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_52.getValue(InventoryCategory.const_123));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_52.getValue(InventoryCategory.const_437) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_95,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_593,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               this.var_1151 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_593:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_52.add(InventoryCategory.const_437,_loc1_);
         ...
         this.var_52.add(InventoryCategory.const_697,_loc4_);
         ...
         this.var_52.add(InventorySubCategory.const_314,_loc6_);
         ...
         this.var_52.add(InventorySubCategory.const_1257,_loc7_);
         ...
         this.var_52.add(InventoryCategory.const_123,_loc8_);
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2231);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_760));
      }
