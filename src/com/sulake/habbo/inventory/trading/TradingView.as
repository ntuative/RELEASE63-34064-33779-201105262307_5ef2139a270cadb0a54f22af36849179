package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1003:uint = 4284532064;
      
      private static const const_1004:uint = 2577770;
      ...
      private var var_599:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_599 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_201)
            {
               this.var_201.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_201.stop();
               this.var_201 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1728 = this.createMinimizedWindow();
         }
         if(!this.var_2378)
         {
            return this.var_72;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1003) : uint(const_1004);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1003) : uint(const_1004);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_201 = new Timer(1000,3);
            this.var_201.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_201.reset();
         this.var_201.repeatCount = 3;
         this.var_201.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_201.currentCount));
         if(this.var_201.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1638)
            {
            ...
            this.var_599.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_495);
            this.var_599.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_599.hideDelayed();
         }
      }
         ...
         if(this.var_183.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_599.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_495);
               }
            }
            else
            {
