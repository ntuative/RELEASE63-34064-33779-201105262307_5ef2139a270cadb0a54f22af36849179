package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1955:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_716);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_343 != null && this.var_343 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_343 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_716);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_67:
               ...
               break;
            case InventoryCategory.const_123:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_343);
         }
         ...
         _loc2_.container.removeChild(this.var_1650);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_343 == InventoryCategory.const_123)
            {
               this.toggleCategoryView(InventoryCategory.const_123);
            }
            else if(this.var_343 == InventoryCategory.const_67)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1651)
         {
            this.var_1651 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1651,_loc1_);
