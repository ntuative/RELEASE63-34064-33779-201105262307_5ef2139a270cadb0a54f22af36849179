package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_234 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_234.id);
            this.var_234 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2281 = _loc2_;
         this.var_2280 = this.var_234.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1814,this.var_1813);
         }
      }
      ...
      {
         if(param1 != this.var_2281 || param2 != this.var_2280)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2278);
      }
