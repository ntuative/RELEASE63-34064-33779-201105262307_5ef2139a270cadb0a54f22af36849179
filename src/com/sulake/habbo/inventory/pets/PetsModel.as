package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_123 && this._controller.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1896 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_32,RoomObjectTypeEnum.const_190,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1896 && param1.type == RoomEngineObjectEvent.const_160)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_536.indexOf(_loc2_) == -1)
            {
               this.var_536.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      {
         return this.var_536.indexOf(param1) > -1;
      }
   }
}
