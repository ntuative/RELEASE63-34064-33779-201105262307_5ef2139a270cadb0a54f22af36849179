package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1971:int = 0;
      
      private const const_1034:int = 1;
      
      private const const_1038:int = 2;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_207 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_573.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_207.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_573 == null || this.var_573.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_573.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_573.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_207.addGridItem(_loc2_.window);
            this.var_573.add(param1.id,_loc2_);
         ...
         if(param1.type == WindowEvent.const_50)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_71.switchToFurnitureCategory(FurniModelCategory.const_44);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_71.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_434) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_71.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_405) > 0;
