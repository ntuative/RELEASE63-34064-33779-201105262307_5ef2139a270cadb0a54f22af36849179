package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1587.setSelectedGridItem(this);
               this.var_1586 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1586 = false;
                  this.var_1587.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1541)
         {
            return;
         }
         this.var_1541.color = !!this.var_1601 ? uint(const_1519) : uint(const_1520);
         this.var_2620.visible = param1;
      }
