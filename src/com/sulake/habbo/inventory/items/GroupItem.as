package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1519:int = 10275685;
      ...
      private var var_1541:IWindow;
      
      private var var_2620:IWindow;
      ...
      protected var var_891:int = 0;
      
      protected var var_711:BitmapData;
      ...
      protected var var_2954:BitmapData;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1541 = this._window.findChildByTag("BG_COLOR");
         this.var_2620 = this._window.findChildByName("outline");
         ...
         this.var_2175 = param8;
         this.var_1536 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2174 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1536));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2175);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1541.color = !!this.var_1517 ? uint(const_1519) : uint(const_1520);
         this.var_2620.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2173 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2954;
               _loc5_.visible = true;
            }
            else
            {
