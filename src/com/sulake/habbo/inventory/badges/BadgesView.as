package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_624:IItemGridWindow;
      
      private var var_970:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_624 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_624.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_970 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_970.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_624.scrollV;
         this.var_624.removeGridItems();
         this.var_970.removeGridItems();
         var _loc2_:Array = this.var_71.getBadges(BadgesModel.const_520);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_624.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_624.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_71.getBadges(BadgesModel.const_340);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_970.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_71.getBadges(BadgesModel.const_340);
      ...
      {
         var _loc2_:int = this.var_624.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_970.getGridItemIndex(param1.window);
