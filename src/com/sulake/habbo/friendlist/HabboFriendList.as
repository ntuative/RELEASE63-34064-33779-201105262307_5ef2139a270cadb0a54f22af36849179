package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2648:FriendListLookAndFeel;
      
      private var var_423:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1917:OpenedToWebPopup;
      ...
      private var var_1916:AvatarSearchResults;
      ...
      {
         this.var_2648 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_107 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1916 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1081)
         {
            this.var_1081.release(new IIDAvatarRenderManager());
            this.var_1081 = null;
         }
         if(this.var_906)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1917 = new OpenedToWebPopup(this);
         }
         this.var_1917.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_391);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_312,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1081.createAvatarImage(param1,AvatarScaleType.const_94,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_906 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_1224,this.getText("friendlist.friends")));
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_394,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_107.findCategory(FriendCategory.const_394);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_423.findTab(FriendListTab.const_100).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_423.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1916.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_423.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_806 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_806.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_48))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_806.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
