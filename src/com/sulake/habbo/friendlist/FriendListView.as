package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1556:Point = new Point(110,50);
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1556;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1061 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_250 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1997.prepare(this.var_1061);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1160,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1315,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_820,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_820,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1564 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1564.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1999 == -1 ? 0 : int(this.var_17.height - this.var_1999);
         var _loc4_:int = this.var_1996 == -1 ? 0 : int(this.var_17.width - this.var_1996);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1153,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1160,false);
         ...
         this.var_1999 = this.var_17.height;
         this.var_1996 = this.var_17.width;
