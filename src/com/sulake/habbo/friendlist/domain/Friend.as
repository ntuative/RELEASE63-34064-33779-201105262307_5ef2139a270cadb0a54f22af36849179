package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2120:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_966 = param1.gender;
         this.var_792 = param1.online;
         this.var_1989 = param1.followingAllowed && param1.online;
         this.var_620 = param1.figure;
         this.var_1827 = param1.motto;
         this.var_1826 = param1.lastAccess;
         this.var_1400 = param1.categoryId;
         this.var_1825 = param1.realName;
