package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_426:int = 100;
      ...
      {
         if(this.var_945 >= this.getPageCount())
         {
            this.var_945 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_227.length / const_426);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_945 * const_426;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_945 + 1) * const_426,this.var_227.length);
      }
