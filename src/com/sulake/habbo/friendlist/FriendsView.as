package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2042:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2639:IContainerButtonWindow;
      
      private var var_2637:IContainerButtonWindow;
      
      private var var_2638:IContainerButtonWindow;
      
      private var var_2459:IContainerButtonWindow;
      
      private var var_59:IItemListWindow;
      
      private var var_599:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_599 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2639 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2637 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2638 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2639,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2637,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2638,this.isEnableInviteButton(_loc1_));
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_599.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_599.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_599.closePopup();
         }
