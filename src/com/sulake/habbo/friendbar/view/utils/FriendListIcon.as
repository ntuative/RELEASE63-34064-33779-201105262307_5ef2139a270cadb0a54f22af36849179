package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1096:int = 500;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1095) : int(const_1096));
         if(!var_890 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_890,!!_hover ? int(const_1095) : int(const_1096));
         if(!var_890 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
