package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1070:Boolean = false;
      
      private static const const_659:String = "Navigation";
      
      private static const const_660:String = "Friend Bar";
      
      private static const const_1560:String = "go.friendbar";
      
      private static const const_1557:String = "chat_btn_click";
      
      private static const const_1561:String = "find_friends_btn_click";
      
      private static const const_1069:String = "Toolbar";
      
      private static const const_1068:String = "open";
      
      private static const const_1071:String = "close";
      
      private static const const_1558:String = "FRIENDLIST";
      
      private static const const_1559:String = "MESSENGER";
       
      
      private var var_85:IHabboCommunicationManager;
      
      private var var_319:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_319)
            {
               this.var_319.release(new IIDHabboFriendList());
               this.var_319 = null;
            }
            if(this.var_460)
            {
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_85)
         {
            ...
            this.var_85.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_660,const_1560));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_460)
         {
            ...
            if(this.var_85)
            {
               this.var_85.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_660,const_1557));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_85)
         {
            ...
            this.var_85.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_660,const_1561));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_319)
         {
            ...
            {
               if(!this.var_319.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_319.openFriendRequests();
                  }
                  else
                  {
                     this.var_319.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_319.mainWindow;
               ...
               if(this.var_85)
               {
                  this.var_85.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1069,const_1558,!!this.var_319.isOpen() ? const_1068 : const_1071));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_460)
         {
            if(!this.var_460.disposed)
            {
               ...
               if(this.var_85)
               {
                  this.var_85.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1069,const_1559,!!this.var_460.isOpen() ? const_1068 : const_1071));
               }
            }
         }
      }
      ...
      {
         this.var_319 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_140 = !!const_302 ? this.sortByNameAndOnlineStatus(this.var_140) : this.sortByName(this.var_140);
         }
